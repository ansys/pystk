...
class OLE_XPOS_PIXELS_arg(object):
    def __init__(self, val: int = None):
        if val is None: 
...
class OLE_YPOS_PIXELS_arg(object):
    def __init__(self, val: int = None):
        if val is None: 
