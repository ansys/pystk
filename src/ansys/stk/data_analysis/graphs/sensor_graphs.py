...
def azimuth_elevation_time_xy_graph(stk_obj :Sensor, start_time=None, stop_time=None, step=60):
    r"""Create plot of the direction of the sensor's boresight over time, expressed as azimuth and elevation in body-fixed axes of the sensor's parent.
...
def footprint_area_time_xy_graph(stk_obj :Sensor, start_time=None, stop_time=None, step=60):
    r"""Create plot of the area on the ground inside the sensor footprint over time.
...
def percent_obscured_time_xy_graph(stk_obj :Sensor, start_time=None, stop_time=None, step=60):
    r"""Create plot of the percentage that the sensor's field of view is obstructed over time, as generated by Sensor Obscuration tool.
