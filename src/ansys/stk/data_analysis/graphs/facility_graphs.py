...
def solar_aer_time_xy_graph(stk_obj :Facility, start_time=None, stop_time=None, step=60):
    r"""Create plot of the azimuth, elevation, and range over time, describing the apparent relative position vector of the Sun with respect to the local horizontal plane.
...
def solar_az_el_polar_center_0_graph(stk_obj :Facility, start_time=None, stop_time=None, step=60):
    r"""Create polar plot with elevation as radius and azimuth as angle theta over time, describing the apparent relative position vector of the Sun with respect to the local horizontal plane.
