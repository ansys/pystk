...
def anchor_point_solar_az_el_time_xy_graph(stk_obj :LineTarget, start_time=None, stop_time=None, step=60):
    r"""Create plot of the elevation and azimuth over time, describing the relative position vector of the apparent Sun to the anchor point, with respect to the local horizontal plane. This frame has the Z axis aligned with the inward surface normal direction (minus Z is up) and the X axis constrained toward the local north direction.
