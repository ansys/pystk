...
def point_coverage_intervals_interval_graph(stk_obj :CoverageDefinition, start_time=None, stop_time=None):
    r"""Createn Interval graph of the access intervals for the point currently selected by the grid inspector. The intervals represent the union of times that the grid point has access to any of the assets.
...
def percentage_of_region_covered_time_xy_graph(stk_obj :CoverageDefinition, start_time=None, stop_time=None, step=60):
    r"""Create plot of the percentage of coverage over time of the region selected by the grid inspector. A region is considered to be covered if at least one point within the region has access to one or more of the assigned assets.
...
def intervals_of_full_regional_coverage_interval_graph(stk_obj :CoverageDefinition, start_time=None, stop_time=None):
    r"""Createn Interval graph of the intervals of time when the region selected by the grid inspector is completely covered. The region is considered to be completely covered when all points within the region are covered. A point is covered when it has access to some asset.
...
def current_and_accumulated_coverage_time_xy_graph(stk_obj :CoverageDefinition, start_time=None, stop_time=None, step=60):
    r"""Create plot of the percentage of the area of the total coverage grid which is covered at the reported time.
