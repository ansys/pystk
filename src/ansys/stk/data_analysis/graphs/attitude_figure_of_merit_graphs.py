...
def grid_stats_over_time_time_xy_graph(stk_obj :IStkObject, start_time=None, stop_time=None, step=60):
	"""A plot of the miniumum, maximum, and average figure of merit values, sampled over all grid directions, over time. Grid directions for which a value cannot be computed are not included in the reported statistics."""
	root = stk_obj.root
