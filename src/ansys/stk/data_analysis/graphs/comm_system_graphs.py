...
def carrier_to_noise_ratio_cdf_chart_xy_graph(stk_obj : CommSystem):
	"""This graph shows the cumulative percentage of occurrence (CDF) as a function of carrier-to-noise ratio.
...
def carrier_to_noise_interference_ratio_cdf_chart_xy_graph(stk_obj : CommSystem):
	"""This graph shows the cumulative percentage of occurrence (CDF) as a function of carrier-to-noise-plus-interference ratio.
...
def carrier_to_noise_interference_ratio_pdf_xy_graph(stk_obj : CommSystem):
	"""This graph shows the percentage of occurrence (PDF) as a function of carrier-to-noise-plus-interference ratio.
...
def carrier_to_noise_ratio_pdf_xy_graph(stk_obj : CommSystem):
	"""This graph shows the percentage of occurrence (PDF) as a function of carrier-to-noise ratio.
...
def carrier_to_noise_vs_time_time_xy_graph(stk_obj :CommSystem, start_time=None, stop_time=None, step=60):
	"""This graph shows the carrier-to-noise ratio and the carrier-to-noise-plus-interference ratio as a function of time.
...
def epfd_cdf_chart_xy_graph(stk_obj : CommSystem):
	"""This graph shows the cumulative percentage of occurrence (CDF) as a function of power flux density.
...
def epfd_xy_graph(stk_obj : CommSystem):
	"""This graph shows the percentage of occurrence (PDF) as a function of power flux density.
