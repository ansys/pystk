...
def re_entry_angle_time_xy_graph(stk_obj :Missile, start_time=None, stop_time=None, step=60):
    r"""Create plot of the altitude and Re-entry Angle (i.e., the angle between the Fixed velocity direction of the object to the local horizontal plane), over time.
