...
def altitude_time_xy_graph(stk_obj :Missile, start_time=None, stop_time=None, step=60):
	"""The altitude of the object (i.e., magnitude of the relative position vector between the object and its detic subpoint) as a function of time
...
def beta_angle_time_xy_graph(stk_obj :Missile, start_time=None, stop_time=None, step=60):
...
def close_approach_periods_interval_graph(stk_obj :Missile, start_time=None, stop_time=None):
	"""An Interval graph of the conjunction time intervals where at least one conjunction occurs with a secondary vehicle, as computed by the Close Approach tool. A conjunction occurs if the object becomes with the specified minimum range threshold to a secondary vehicle at some time.

	This graph wrapper was generated from AGI\STK12\STKData\Styles\Missile\Close Approach Periods.rsg.
	"""
	root = stk_obj.root
	if start_time is None:
		start_time = root.current_scenario.start_time
...
def cumulative_sunlight_cumulative_pie_graph(stk_obj :Missile, start_time=None, stop_time=None):
...
def eclipse_times_interval_graph(stk_obj :Missile, start_time=None, stop_time=None):
...
def fixed_position_velocity_time_xy_graph(stk_obj :Missile, start_time=None, stop_time=None, step=60):
	"""The position and velocity of the object with respect to the object's central body, as observed from its central body's Fixed coordinate system, expressed in Cartesian components as a function of time.
...
def j2000_position_velocity_time_xy_graph(stk_obj :Missile, start_time=None, stop_time=None, step=60):
	"""The position and velocity of the object with respect to the object's central body, as observed from its central body's J2000 coordinate system, expressed in Cartesian components as a function of time.
...
def lighting_times_interval_graph(stk_obj :Missile, start_time=None, stop_time=None):
...
def lla_position_time_xy_graph(stk_obj :Missile, start_time=None, stop_time=None, step=60):
...
def model_area_time_xy_graph(stk_obj :Missile, start_time=None, stop_time=None, step=60):
...
def re_entry_angle_time_xy_graph(stk_obj :Missile, start_time=None, stop_time=None, step=60):
	"""A plot of the altitude and Re-entry Angle (i.e., the angle between the Fixed velocity direction of the object to the local horizontal plane), over time.
	...
	if stop_time is None:
		stop_time = root.current_scenario.stop_time
	df = stk_obj.data_providers.item('Angles').group.item('Re-entry').exec(start_time, stop_time, step).data_sets.to_pandas_dataframe()
	axes = [{'use_unit' : None, 'unit_squared': None, 'ylog10': False, 'y2log10': False, 'label': 'Angle', 'lines': [
			{'y_name':'re-entry angle', 'label':'Re-entry Angle', 'use_unit':None, 'unit_squared': None, 'unit_pref': 'Angle'}]},
			{'use_unit' : None, 'unit_squared': None, 'ylog10': False, 'y2log10': False, 'label': 'Distance', 'lines': [
			{'y_name':'alt', 'label':'Alt', 'use_unit':None, 'unit_squared': None, 'unit_pref': 'Distance'}]}]
	return line_chart_time_x(df, root, ['re-entry angle','alt'], ['time'], axes, 'Re-entry Angle')

def ecivvlh_solar_aer_time_xy_graph(stk_obj :Missile, start_time=None, stop_time=None, step=60):
	"""A plot of the azimuth, elevation, and range over time, describing the apparent relative position vector of the Sun with respect to Inertial VVLH axes (ECIVVLH).
...
def solar_ecf_vvlh_az_el_polar_center_0_graph(stk_obj :Missile, start_time=None, stop_time=None, step=60):
	"""A polar plot with elevation as radius and azimuth as angle theta over time, describing the apparent relative position vector of the Sun with respect to Inertial VVLH axes (ECIVVLH).
...
def solar_intensity_time_xy_graph(stk_obj :Missile, start_time=None, stop_time=None, step=60):
...
def sunlight_intervals_interval_pie_graph(stk_obj :Missile, start_time=None, stop_time=None):
