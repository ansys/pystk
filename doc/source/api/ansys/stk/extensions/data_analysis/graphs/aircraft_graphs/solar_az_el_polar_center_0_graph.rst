...
.. py:function:: ansys.stk.extensions.data_analysis.graphs.aircraft_graphs.solar_az_el_polar_center_0_graph(stk_object: ~Aircraft, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
