...
.. py:function:: ansys.stk.extensions.data_analysis.graphs.aircraft_graphs.flight_profile_by_downrange_line_chart(stk_object: ~Aircraft, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
