...
.. image:: /graph_images_temp/test_lla_position_line_chart_ship.png
  :width: 600
  :alt: image of output from lla_position_line_chart

.. py:function:: lla_position_line_chart(stk_object: ~Ship, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.ship_graphs.lla_position_line_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.ship_graphs import lla_position_line_chart
