...
.. image:: /graph_images_temp/test_polewanderx_line_chart_scenario.png
  :width: 600
  :alt: image of output from polewanderx_line_chart

.. py:function:: polewanderx_line_chart(stk_object: ~Scenario, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.scenario_graphs.polewanderx_line_chart
...
.. py:currentmodule:: polewanderx_line_chart
