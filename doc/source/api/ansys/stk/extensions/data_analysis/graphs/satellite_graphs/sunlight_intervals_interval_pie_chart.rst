...
.. py:function:: ansys.stk.extensions.data_analysis.graphs.satellite_graphs.sunlight_intervals_interval_pie_chart(stk_object: ~Satellite, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, color_list: list[~typing.Any] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.satellite_graphs.sunlight_intervals_interval_pie_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.satellite_graphs import sunlight_intervals_interval_pie_chart
