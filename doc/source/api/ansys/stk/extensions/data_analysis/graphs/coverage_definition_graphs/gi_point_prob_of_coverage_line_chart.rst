...
.. py:function:: ansys.stk.extensions.data_analysis.graphs.coverage_definition_graphs.gi_point_prob_of_coverage_line_chart(stk_object: ~CoverageDefinition, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
