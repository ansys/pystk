...
.. py:function:: cumulative_sunlight_cumulative_pie_chart(stk_object: ~Place, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, color_list: list[~typing.Any] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
