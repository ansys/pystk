...
.. image:: /graph_images_temp/test_solar_az_el_polar_center_0_graph_launchvehicle.png
  :width: 600
  :alt: image of output from solar_az_el_polar_center_0_graph

.. py:function:: ansys.stk.extensions.data_analysis.graphs.launch_vehicle_graphs.solar_az_el_polar_center_0_graph(stk_object: ~LaunchVehicle, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.launch_vehicle_graphs.solar_az_el_polar_center_0_graph
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.launch_vehicle_graphs import solar_az_el_polar_center_0_graph
