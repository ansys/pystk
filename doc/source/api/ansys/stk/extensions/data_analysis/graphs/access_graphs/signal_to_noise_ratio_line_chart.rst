signal_to_noise_ratio_line_chart
================================

.. image:: /graph_images_temp/test_signal_to_noise_ratio_line_chart_access.png
  :width: 600
  :alt: image of output from signal_to_noise_ratio_line_chart

.. py:function:: ansys.stk.extensions.data_analysis.graphs.access_graphs.signal_to_noise_ratio_line_chart(stk_object: ~Access, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.access_graphs.signal_to_noise_ratio_line_chart
...
.. py:currentmodule:: signal_to_noise_ratio_line_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.access_graphs import signal_to_noise_ratio_line_chart
