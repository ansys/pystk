...
.. image:: /graph_images_temp/test_euler_angles_line_chart_missile.png
  :width: 600
  :alt: image of output from euler_angles_line_chart

.. py:function:: euler_angles_line_chart(stk_object: ~Missile, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.missile_graphs.euler_angles_line_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.missile_graphs import euler_angles_line_chart
