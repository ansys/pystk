radar_searchtrack_snr_line_chart
================================

.. image:: /graph_images_temp/test_radar_searchtrack_snr_line_chart_access.png
  :width: 600
  :alt: image of output from radar_searchtrack_snr_line_chart

.. py:function:: radar_searchtrack_snr_line_chart(stk_object: ~Access, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.access_graphs.radar_searchtrack_snr_line_chart
...
.. py:currentmodule:: radar_searchtrack_snr_line_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.access_graphs import radar_searchtrack_snr_line_chart
