...
.. image:: /graph_images_temp/test_gi_point_coverage_interval_graph_coveragedefinition.png
  :width: 600
  :alt: image of output from gi_point_coverage_interval_graph

.. py:function:: ansys.stk.extensions.data_analysis.graphs.coverage_definition_graphs.gi_point_coverage_interval_graph(stk_object: ~CoverageDefinition, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.coverage_definition_graphs.gi_point_coverage_interval_graph
...
.. py:currentmodule:: gi_point_coverage_interval_graph
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.coverage_definition_graphs import gi_point_coverage_interval_graph
