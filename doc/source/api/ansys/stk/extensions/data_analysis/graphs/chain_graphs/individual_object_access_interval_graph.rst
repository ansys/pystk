...
.. image:: /graph_images_temp/test_individual_object_access_interval_graph_chain.png
  :width: 600
  :alt: image of output from individual_object_access_interval_graph

.. py:function:: individual_object_access_interval_graph(stk_object: ~Chain, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.chain_graphs.individual_object_access_interval_graph
...
.. py:currentmodule:: individual_object_access_interval_graph
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.chain_graphs import individual_object_access_interval_graph
