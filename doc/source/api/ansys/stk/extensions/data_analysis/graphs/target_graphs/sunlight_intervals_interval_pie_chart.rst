...
.. py:function:: sunlight_intervals_interval_pie_chart(stk_object: ~Target, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, color_list: list[~typing.Any] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
