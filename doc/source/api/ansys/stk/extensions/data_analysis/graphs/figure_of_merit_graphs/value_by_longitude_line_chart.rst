...
.. image:: /graph_images_temp/test_value_by_longitude_line_chart_figureofmerit.png
  :width: 600
  :alt: image of output from value_by_longitude_line_chart

.. py:function:: value_by_longitude_line_chart(stk_object: ~FigureOfMerit, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.figure_of_merit_graphs.value_by_longitude_line_chart
...
.. py:currentmodule:: value_by_longitude_line_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.figure_of_merit_graphs import value_by_longitude_line_chart
