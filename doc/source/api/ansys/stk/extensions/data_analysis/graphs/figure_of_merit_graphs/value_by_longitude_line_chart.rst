...
.. py:function:: ansys.stk.extensions.data_analysis.graphs.figure_of_merit_graphs.value_by_longitude_line_chart(stk_object: ~FigureOfMerit, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
