...
.. image:: /graph_images_temp/test_cumulative_sunlight_cumulative_pie_chart_satellite.png
  :width: 600
  :alt: image of output from cumulative_sunlight_cumulative_pie_chart

.. py:function:: ansys.stk.extensions.data_analysis.graphs.satellite_graphs.cumulative_sunlight_cumulative_pie_chart(stk_object: ~Satellite, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, color_list: list[~typing.Any] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.satellite_graphs.cumulative_sunlight_cumulative_pie_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.satellite_graphs import cumulative_sunlight_cumulative_pie_chart
