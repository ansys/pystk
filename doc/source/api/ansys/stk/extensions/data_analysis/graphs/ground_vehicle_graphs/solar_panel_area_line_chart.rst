...
.. image:: /graph_images_temp/solar_panel_area_line_chart.png
  :width: 600
  :alt: image of output from solar_panel_area_line_chart

.. py:function:: ansys.stk.extensions.data_analysis.graphs.ground_vehicle_graphs.solar_panel_area_line_chart(stk_object: ~GroundVehicle, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.ground_vehicle_graphs.solar_panel_area_line_chart
...
.. py:currentmodule:: solar_panel_area_line_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.ground_vehicle_graphs import solar_panel_area_line_chart
