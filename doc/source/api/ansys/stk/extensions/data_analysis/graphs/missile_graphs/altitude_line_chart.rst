...
.. image:: /graph_images_temp/test_altitude_line_chart_missile.png
  :width: 600
  :alt: image of output from altitude_line_chart

.. py:function:: altitude_line_chart(stk_object: ~Missile, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.missile_graphs.altitude_line_chart
...
.. py:currentmodule:: altitude_line_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.missile_graphs import altitude_line_chart
