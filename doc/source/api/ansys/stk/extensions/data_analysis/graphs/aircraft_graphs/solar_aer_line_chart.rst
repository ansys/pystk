...
.. image:: /graph_images_temp/test_solar_aer_line_chart_aircraft.png
  :width: 600
  :alt: image of output from solar_aer_line_chart

.. py:function:: solar_aer_line_chart(stk_object: ~Aircraft, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.aircraft_graphs.solar_aer_line_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.aircraft_graphs import solar_aer_line_chart
