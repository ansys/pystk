...
.. image:: /graph_images_temp/test_percent_coverage_line_chart_coveragedefinition.png
  :width: 600
  :alt: image of output from percent_coverage_line_chart

.. py:function:: ansys.stk.extensions.data_analysis.graphs.coverage_definition_graphs.percent_coverage_line_chart(stk_object: ~CoverageDefinition, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.coverage_definition_graphs.percent_coverage_line_chart
...
.. py:currentmodule:: percent_coverage_line_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.coverage_definition_graphs import percent_coverage_line_chart
