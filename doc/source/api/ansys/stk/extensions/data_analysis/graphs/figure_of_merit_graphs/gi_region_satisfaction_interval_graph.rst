...
.. image:: /graph_images_temp/test_gi_region_satisfaction_interval_graph_figureofmerit.png
  :width: 600
  :alt: image of output from gi_region_satisfaction_interval_graph

.. py:function:: gi_region_satisfaction_interval_graph(stk_object: ~FigureOfMerit, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.figure_of_merit_graphs.gi_region_satisfaction_interval_graph
...
.. py:currentmodule:: gi_region_satisfaction_interval_graph
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.figure_of_merit_graphs import gi_region_satisfaction_interval_graph
