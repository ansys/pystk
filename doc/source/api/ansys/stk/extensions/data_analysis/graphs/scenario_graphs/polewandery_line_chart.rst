polewandery_line_chart
======================

.. image:: /graph_images_temp/test_polewandery_line_chart_scenario.png
  :width: 600
  :alt: image of output from polewandery_line_chart

.. py:function:: polewandery_line_chart(stk_object: ~Scenario, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.scenario_graphs.polewandery_line_chart

    Create a plot of the Y component of pole wander over time.
...
.. py:currentmodule:: polewandery_line_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.scenario_graphs import polewandery_line_chart
