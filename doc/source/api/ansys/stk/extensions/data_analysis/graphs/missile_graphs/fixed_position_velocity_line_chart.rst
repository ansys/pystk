fixed_position_velocity_line_chart
==================================

.. image:: /graph_images_temp/test_fixed_position_velocity_line_chart_missile.png
  :width: 600
  :alt: image of output from fixed_position_velocity_line_chart

.. py:function:: ansys.stk.extensions.data_analysis.graphs.missile_graphs.fixed_position_velocity_line_chart(stk_object: ~Missile, start_time: ~typing.Any = None, stop_time: ~typing.Any = None, step: ~float = 60, colormap: ~matplotlib.colors.Colormap = None, time_unit_abbreviation: ~str = 'UTCG', formatter: collections.abc.Callable[[float, float], str] = None) -> ~matplotlib.figure.Figure, ~matplotlib.axes.Axes
    :canonical: ansys.stk.extensions.data_analysis.graphs.missile_graphs.fixed_position_velocity_line_chart
...
.. py:currentmodule:: fixed_position_velocity_line_chart
...
.. code-block:: python
    ...
    from ansys.stk.extensions.data_analysis.graphs.missile_graphs import fixed_position_velocity_line_chart
