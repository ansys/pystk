...
.. py:method:: start_application(grpc_host: str = localhost, grpc_port: int = localhost, grpc_timeout_sec: int = localhost, grpc_max_message_size: int = localhost, user_control: bool = localhost, no_graphics: bool = localhost) -> STKRuntimeApplication
...
.. py:method:: attach_to_application(grpc_host: str = localhost, grpc_port: int = localhost, grpc_timeout_sec: int = localhost, grpc_max_message_size: int = localhost) -> STKRuntimeApplication
