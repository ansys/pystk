...
.. py:currentmodule:: ISTKXApplication
...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkx.ISTKXApplication.execute_command`
              - Send a connect command to STK X.
            * - :py:attr:`~ansys.stk.core.stkx.ISTKXApplication.get_licensing_report`
            ...
            * - :py:attr:`~ansys.stk.core.stkx.ISTKXApplication.set_online_options`
              - Set http proxy online options.
            * - :py:attr:`~ansys.stk.core.stkx.ISTKXApplication.get_online_options`
              - Get http proxy online options.
            * - :py:attr:`~ansys.stk.core.stkx.ISTKXApplication.set_connect_handler`
              - Set callback to handle a certain connect command.
            * - :py:attr:`~ansys.stk.core.stkx.ISTKXApplication.execute_multiple_commands`
              - Execute multiple CONNECT actions. The method throws an exception if any of the specified commands have failed.
            * - :py:attr:`~ansys.stk.core.stkx.ISTKXApplication.is_feature_available`
              - Return true if the specified feature is available.
            * - :py:attr:`~ansys.stk.core.stkx.ISTKXApplication.terminate`
              - Terminates the use of STK Engine. This must be the last call to STK Engine.
            * - :py:attr:`~ansys.stk.core.stkx.ISTKXApplication.use_software_renderer`
