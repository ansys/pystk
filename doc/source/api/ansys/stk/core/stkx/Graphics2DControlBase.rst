...
.. py:currentmodule:: Graphics2DControlBase
...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.picture_put_reference`
              - Set a reference to the splash logo graphic to be displayed in the control.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.zoom_in`
              - Enter zoom-in mode. User must left click-and-drag mouse to define area to zoom.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.zoom_out`
              - Zoom out to view a larger portion of a previously magnified map.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.pick_info`
              - Get detailed information about a mouse pick.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.copy_from_win_id`
              - Copy an existing Window's scene into this control.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.rubber_band_pick_info`
            ...
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.get_window_projected_position`
              - Get the window projected position for given values.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.set_mouse_cursor_from_file`
              - Set mouse cursor to the selected cursor file.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.restore_mouse_cursor`
              - Restores mouse cursor back to normal.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.set_mouse_cursor_from_handle`
              - Set mouse cursor to the passed cursor handle.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.Subscribe`
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.back_color`
              - The background color of the control.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.picture`
              - The splash logo graphic to be displayed in the control.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.win_id`
              - Window identifier (for Connect commands).
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.application`
              - Reference to the STK X application object.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.no_logo`
            ...
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.progress_image_y_offset`
              - The vertical Y offset for animated progress image.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.progress_image_file`
              - The complete image file name/path for animated progress image.
            * - :py:attr:`~ansys.stk.core.stkx.Graphics2DControlBase.progress_image_x_origin`
...
.. py:property:: back_color
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.back_color
    :type: agcolor.Color

    The background color of the control.

.. py:property:: picture
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.picture
    :type: IPictureDisp

    The splash logo graphic to be displayed in the control.

.. py:property:: win_id
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.win_id
    :type: int

    Window identifier (for Connect commands).

.. py:property:: application
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.application
    :type: STKXApplication

    Reference to the STK X application object.

.. py:property:: no_logo
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.no_logo
    :type: bool
...
.. py:property:: progress_image_x_offset
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.progress_image_x_offset
    :type: int

    The horizontal X offset for animated progress image.

.. py:property:: progress_image_y_offset
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.progress_image_y_offset
    :type: int

    The vertical Y offset for animated progress image.

.. py:property:: progress_image_file
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.progress_image_file
    :type: str
...
.. py:method:: zoom_out(self) -> None
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.zoom_out
...
.. py:method:: pick_info(self, x: int, y: int) -> PickInfoData
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.pick_info
...
.. py:method:: copy_from_win_id(self, winID: int) -> None
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.copy_from_win_id
...
.. py:method:: rubber_band_pick_info(self, left: int, top: int, right: int, bottom: int) -> RubberBandPickInfoData
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.rubber_band_pick_info
...
.. py:method:: restore_mouse_cursor(self) -> None
    :canonical: ansys.stk.core.stkx.Graphics2DControlBase.restore_mouse_cursor
