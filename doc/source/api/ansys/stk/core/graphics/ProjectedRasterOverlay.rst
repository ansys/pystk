...
.. py:class:: ansys.stk.core.graphics.ProjectedRasterOverlay
   ...
   Bases: :py:class:`~ansys.stk.core.graphics.IProjectedRasterOverlay`, :py:class:`~ansys.stk.core.graphics.IGlobeImageOverlay`, :py:class:`~ansys.stk.core.graphics.IGlobeOverlay`
