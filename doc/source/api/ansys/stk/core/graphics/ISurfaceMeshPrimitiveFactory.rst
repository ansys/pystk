...
.. py:method:: initialize(self) -> ISurfaceMeshPrimitive
    :canonical: ansys.stk.core.graphics.ISurfaceMeshPrimitiveFactory.initialize
...
.. py:method:: initialize_with_set_hint(self, setHint: SET_HINT) -> ISurfaceMeshPrimitive
    :canonical: ansys.stk.core.graphics.ISurfaceMeshPrimitiveFactory.initialize_with_set_hint
...
.. py:method:: initialize_with_set_hint_and_rendering_method(self, setHint: SET_HINT, renderingMethod: SURFACE_MESH_RENDERING_METHOD) -> ISurfaceMeshPrimitive
    :canonical: ansys.stk.core.graphics.ISurfaceMeshPrimitiveFactory.initialize_with_set_hint_and_rendering_method
...
.. py:method:: supported(self, renderingMethod: SURFACE_MESH_RENDERING_METHOD) -> bool
    :canonical: ansys.stk.core.graphics.ISurfaceMeshPrimitiveFactory.supported
...
.. py:method:: supported_with_default_rendering_method(self) -> bool
    :canonical: ansys.stk.core.graphics.ISurfaceMeshPrimitiveFactory.supported_with_default_rendering_method
