The ``jupyterwidgets`` module
=============================

.. py:module:: ansys.stk.core.experimental.jupyterwidgets
...
.. tab-set::
    ...
    .. tab-item:: Classes
        ...
        .. list-table::
            ...
            * - :py:class:`~ansys.stk.core.experimental.jupyterwidgets.AsyncioTimerManager`
              - Provide timer support for animation in jupyter notebooks.

            * - :py:class:`~ansys.stk.core.experimental.jupyterwidgets.GfxAnalysisWidget`
              - The Graphics Analysis widget for jupyter.

            * - :py:class:`~ansys.stk.core.experimental.jupyterwidgets.GlobeWidget`
              - The 3D Globe widget for jupyter.

            * - :py:class:`~ansys.stk.core.experimental.jupyterwidgets.MapWidget`
              - The 2D Map widget for jupyter.

            * - :py:class:`~ansys.stk.core.experimental.jupyterwidgets.RemoteFrameBufferHost`
              - Implements IRemoteFrameBufferHost.

            * - :py:class:`~ansys.stk.core.experimental.jupyterwidgets.RemoteFrameBufferHostVTable`
...
.. py:currentmodule:: ansys.stk.core.experimental.jupyterwidgets
