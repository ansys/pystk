COVERAGE_REGION_ACCESS_ACCELERATION_TYPE
========================================
...
.. py:currentmodule:: COVERAGE_REGION_ACCESS_ACCELERATION_TYPE
...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import COVERAGE_REGION_ACCESS_ACCELERATION_TYPE
