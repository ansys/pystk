SENSOR_ALTITUDE_CROSSING_SIDE_TYPE
==================================
...
.. py:currentmodule:: SENSOR_ALTITUDE_CROSSING_SIDE_TYPE
...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import SENSOR_ALTITUDE_CROSSING_SIDE_TYPE
