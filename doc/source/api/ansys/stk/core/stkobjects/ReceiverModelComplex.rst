    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.ReceiverModelComplex.supported_filters`
              - This property is deprecated. Use FilterComponentLinking on IAgReceiverModelComplex instead. Gets an array of supported filter model names.
            * - :py:attr:`~ansys.stk.core.stkobjects.ReceiverModelComplex.filter`
              - This property is deprecated. Use FilterComponentLinking on IAgReceiverModelComplex instead. Gets the current filter model.
