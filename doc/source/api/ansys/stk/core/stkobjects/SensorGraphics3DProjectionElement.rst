...
.. py:currentmodule:: SensorGraphics3DProjectionElement
...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.SensorGraphics3DProjectionElement.time`
              - Time used together with distance to compute the space projection. Uses DateFormat Dimension.
            * - :py:attr:`~ansys.stk.core.stkobjects.SensorGraphics3DProjectionElement.distance`
...
.. py:property:: time
    :canonical: ansys.stk.core.stkobjects.SensorGraphics3DProjectionElement.time
    :type: typing.Any

    Time used together with distance to compute the space projection. Uses DateFormat Dimension.

.. py:property:: distance
    :canonical: ansys.stk.core.stkobjects.SensorGraphics3DProjectionElement.distance
    :type: float
