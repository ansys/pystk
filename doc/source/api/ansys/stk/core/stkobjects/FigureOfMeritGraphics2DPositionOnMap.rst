...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.FigureOfMeritGraphics2DPositionOnMap.x`
              - Gets or sets the X coordinate of the contour legend on the 2D map.
            * - :py:attr:`~ansys.stk.core.stkobjects.FigureOfMeritGraphics2DPositionOnMap.y`
...
.. py:property:: x
    :canonical: ansys.stk.core.stkobjects.FigureOfMeritGraphics2DPositionOnMap.x
    :type: int

    Gets or sets the X coordinate of the contour legend on the 2D map.

.. py:property:: y
    :canonical: ansys.stk.core.stkobjects.FigureOfMeritGraphics2DPositionOnMap.y
    :type: int
