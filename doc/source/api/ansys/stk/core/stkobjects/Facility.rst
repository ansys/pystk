...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.Facility.terrain_norm`
              - Set the normal to the local terrain.
            * - :py:attr:`~ansys.stk.core.stkobjects.Facility.terrain_norm_data`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.Facility.lighting_max_step`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.Facility.max_range_when_computing_az_el_mask`
...
.. py:property:: terrain_norm
    :canonical: ansys.stk.core.stkobjects.Facility.terrain_norm
    :type: None

    Set the normal to the local terrain.

.. py:property:: terrain_norm_data
    :canonical: ansys.stk.core.stkobjects.Facility.terrain_norm_data
...
.. py:property:: lighting_max_step
    :canonical: ansys.stk.core.stkobjects.Facility.lighting_max_step
    :type: float
...
.. py:property:: max_range_when_computing_az_el_mask
    :canonical: ansys.stk.core.stkobjects.Facility.max_range_when_computing_az_el_mask
    :type: float
