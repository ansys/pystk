...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import IFigureOfMeritAssetListCollection
...
.. py:property:: count
    :canonical: ansys.stk.core.stkobjects.IFigureOfMeritAssetListCollection.count
    :type: int

    Returns the number of elements in a collection.

.. py:property:: _NewEnum
    :canonical: ansys.stk.core.stkobjects.IFigureOfMeritAssetListCollection._NewEnum
