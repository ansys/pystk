...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.StkAccessGraphics.static_graphics_2d`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.StkAccessGraphics.line_width`
              - Line width of lines between objects during access periods in the 2D and 3D Graphics windows.
            * - :py:attr:`~ansys.stk.core.stkobjects.StkAccessGraphics.line_style`
...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import StkAccessGraphics
...
.. py:property:: inherit
    :canonical: ansys.stk.core.stkobjects.StkAccessGraphics.inherit
    :type: bool

    Specifies whether the Access graphics inherit from the Scenario. Otherwise they can be set locally for this object.

.. py:property:: line_visible
    :canonical: ansys.stk.core.stkobjects.StkAccessGraphics.line_visible
    :type: bool

    Specifies whether a line appears between objects during access periods in the 2D and 3D Graphics windows.

.. py:property:: animate_graphics_2d
    :canonical: ansys.stk.core.stkobjects.StkAccessGraphics.animate_graphics_2d
    :type: bool

    Specifies whether an Animate Highlight appears in the 2D Graphics window during access periods. The Animate Highlight is a box drawn around each object participating in the access.

.. py:property:: static_graphics_2d
    :canonical: ansys.stk.core.stkobjects.StkAccessGraphics.static_graphics_2d
    :type: bool

    Specifies whether a Static Highlight appears in the 2D Graphics window. The Static Highlight is a thick line overlaying portions of a vehicle's ground track during access periods.

.. py:property:: line_width
    :canonical: ansys.stk.core.stkobjects.StkAccessGraphics.line_width
    :type: int

    Line width of lines between objects during access periods in the 2D and 3D Graphics windows.

.. py:property:: line_style
    :canonical: ansys.stk.core.stkobjects.StkAccessGraphics.line_style
    :type: str
