...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:meth:`~crres_proton_activity`
            * - :py:meth:`~crres_radiation_activity`
            * - :py:meth:`~nasa_energy_values`
            * - :py:meth:`~nasa_models_activity`
