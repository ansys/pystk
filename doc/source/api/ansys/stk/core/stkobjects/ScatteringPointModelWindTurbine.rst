...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.ScatteringPointModelWindTurbine.blade_length`
...
.. py:property:: blade_length
    :canonical: ansys.stk.core.stkobjects.ScatteringPointModelWindTurbine.blade_length
    :type: float

    Get the turbine blade length.

.. py:property:: blade_rotation
    :canonical: ansys.stk.core.stkobjects.ScatteringPointModelWindTurbine.blade_rotation
    :type: float
...
.. py:property:: structure_scattering_cross_section
    :canonical: ansys.stk.core.stkobjects.ScatteringPointModelWindTurbine.structure_scattering_cross_section
    :type: float
