...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.VehicleGraphics3DTrajectoryProximity.control_box`
              - Get the control box parameters.
            * - :py:attr:`~ansys.stk.core.stkobjects.VehicleGraphics3DTrajectoryProximity.bearing_box`
              - Get the bearing box parameters.
            * - :py:attr:`~ansys.stk.core.stkobjects.VehicleGraphics3DTrajectoryProximity.bearing_ellipse`
...
.. py:property:: control_box
    :canonical: ansys.stk.core.stkobjects.VehicleGraphics3DTrajectoryProximity.control_box
    :type: VehicleGraphics3DControlBox

    Get the control box parameters.

.. py:property:: bearing_box
    :canonical: ansys.stk.core.stkobjects.VehicleGraphics3DTrajectoryProximity.bearing_box
    :type: VehicleGraphics3DBearingBox

    Get the bearing box parameters.

.. py:property:: bearing_ellipse
    :canonical: ansys.stk.core.stkobjects.VehicleGraphics3DTrajectoryProximity.bearing_ellipse
    :type: VehicleGraphics3DBearingEllipse

    Get the bearing ellipse parameters.

.. py:property:: line_of_bearing
    :canonical: ansys.stk.core.stkobjects.VehicleGraphics3DTrajectoryProximity.line_of_bearing
