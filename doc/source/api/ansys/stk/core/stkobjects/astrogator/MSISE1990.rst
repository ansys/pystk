...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.MSISE1990.atmos_data_source`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.MSISE1990.atmos_data_geo_magnetic_flux_source`
              - Whether to use Kp or Ap data from the flux file.
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.MSISE1990.atmos_data_geo_magnetic_flux_update_rate`
              - Gets or sets the update rate for geomagnetic flux values from the flux file.
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.MSISE1990.atmos_data_filename`
...
.. py:property:: atmos_data_source
    :canonical: ansys.stk.core.stkobjects.astrogator.MSISE1990.atmos_data_source
...
.. py:property:: atmos_data_geo_magnetic_flux_source
    :canonical: ansys.stk.core.stkobjects.astrogator.MSISE1990.atmos_data_geo_magnetic_flux_source
    :type: GeoMagneticFluxSource

    Whether to use Kp or Ap data from the flux file.

.. py:property:: atmos_data_geo_magnetic_flux_update_rate
    :canonical: ansys.stk.core.stkobjects.astrogator.MSISE1990.atmos_data_geo_magnetic_flux_update_rate
    :type: GeoMagneticFluxUpdateRate

    Gets or sets the update rate for geomagnetic flux values from the flux file.

.. py:property:: atmos_data_filename
    :canonical: ansys.stk.core.stkobjects.astrogator.MSISE1990.atmos_data_filename
    :type: str
