...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects.astrogator import IThruster
...
.. py:property:: name
    :canonical: ansys.stk.core.stkobjects.astrogator.IThruster.name
    :type: str

    Gets or sets the thruster name.

.. py:property:: user_comment
    :canonical: ansys.stk.core.stkobjects.astrogator.IThruster.user_comment
    :type: str

    A user comment.

.. py:property:: engine_model_name
    :canonical: ansys.stk.core.stkobjects.astrogator.IThruster.engine_model_name
    :type: str

    Gets or sets the engine model.

.. py:property:: thruster_efficiency
    :canonical: ansys.stk.core.stkobjects.astrogator.IThruster.thruster_efficiency
    :type: float

    Gets or sets the thruster efficiency. Dimensionless.

.. py:property:: equivalent_on_time
    :canonical: ansys.stk.core.stkobjects.astrogator.IThruster.equivalent_on_time
    :type: float
...
.. py:property:: control_parameters_available
    :canonical: ansys.stk.core.stkobjects.astrogator.IThruster.control_parameters_available
    :type: bool
