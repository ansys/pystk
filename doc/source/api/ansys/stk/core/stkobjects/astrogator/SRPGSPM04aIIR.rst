...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.SRPGSPM04aIIR.atmosphere_altitude`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.SRPGSPM04aIIR.eclipsing_bodies`
...
.. py:property:: atmosphere_altitude
    :canonical: ansys.stk.core.stkobjects.astrogator.SRPGSPM04aIIR.atmosphere_altitude
    :type: float

    Get or set the atmospheric altitude for eclipse. A simple model to account for some measure of attenuation that simply increases the shape of the Earth by the defined altitude height, often taken to be 23 km. Uses Distance Dimension.

.. py:property:: eclipsing_bodies
    :canonical: ansys.stk.core.stkobjects.astrogator.SRPGSPM04aIIR.eclipsing_bodies
    :type: CentralBodyComponentCollection

    Other eclipsing bodies.

.. py:property:: include_boundary_mitigation
    :canonical: ansys.stk.core.stkobjects.astrogator.SRPGSPM04aIIR.include_boundary_mitigation
    :type: bool
...
.. py:property:: solar_radius
    :canonical: ansys.stk.core.stkobjects.astrogator.SRPGSPM04aIIR.solar_radius
    :type: float

    Get or set the solar radius value to use in eclipse calculations.  Uses Distance Dimension.

.. py:property:: sun_position
    :canonical: ansys.stk.core.stkobjects.astrogator.SRPGSPM04aIIR.sun_position
    :type: SunPosition
