...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.DTM2020.atmosphere_data_filename`
              - Flux file.
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.DTM2020.atmosphere_data_geo_magnetic_flux_source`
              - Whether to use Kp or Ap data from the flux file.
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.DTM2020.atmosphere_data_geo_magnetic_flux_update_rate`
              - Get or set the update rate of geomagnetic flux values from the flux file.
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.DTM2020.atmosphere_data_source`
              - Get or set the atmospheric model data source - data file or constant values.
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.DTM2020.computes_pressure`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.DTM2020.drag_model_type`
              - Drag model type.
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.DTM2020.f_10_p7`
              - Solar Flux (F10.7); the daily Ottawa 10.7 cm solar flux value. Dimensionless.
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.DTM2020.f_10_p7_avg`
              - Average solar Flux (F10.7); the 81-day averaged Ottawa 10.7 cm solar flux value. Dimensionless.
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.DTM2020.kp`
...
.. py:property:: atmosphere_data_filename
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.atmosphere_data_filename
    :type: str

    Flux file.

.. py:property:: atmosphere_data_geo_magnetic_flux_source
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.atmosphere_data_geo_magnetic_flux_source
    :type: GeoMagneticFluxSource

    Whether to use Kp or Ap data from the flux file.

.. py:property:: atmosphere_data_geo_magnetic_flux_update_rate
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.atmosphere_data_geo_magnetic_flux_update_rate
    :type: GeoMagneticFluxUpdateRate

    Get or set the update rate of geomagnetic flux values from the flux file.

.. py:property:: atmosphere_data_source
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.atmosphere_data_source
    :type: AtmosphereDataSource

    Get or set the atmospheric model data source - data file or constant values.

.. py:property:: computes_pressure
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.computes_pressure
    :type: bool

    Flag indicates whether this model computes pressure.

.. py:property:: computes_temperature
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.computes_temperature
    :type: bool
...
.. py:property:: drag_model_plugin_name
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.drag_model_plugin_name
    :type: str

    Get or set the name of the drag model plugin.

.. py:property:: drag_model_type
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.drag_model_type
    :type: DragModelType

    Drag model type.

.. py:property:: f_10_p7
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.f_10_p7
    :type: float

    Solar Flux (F10.7); the daily Ottawa 10.7 cm solar flux value. Dimensionless.

.. py:property:: f_10_p7_avg
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.f_10_p7_avg
    :type: float

    Average solar Flux (F10.7); the 81-day averaged Ottawa 10.7 cm solar flux value. Dimensionless.

.. py:property:: kp
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.kp
    :type: float

    Geomagnetic Index (Kp). Dimensionless.

.. py:property:: n_plate_definition_file
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.n_plate_definition_file
    :type: str
...
.. py:property:: use_approximate_altitude
    :canonical: ansys.stk.core.stkobjects.astrogator.DTM2020.use_approximate_altitude
    :type: bool
