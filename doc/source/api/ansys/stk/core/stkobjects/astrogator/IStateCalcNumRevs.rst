...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects.astrogator import IStateCalcNumRevs
...
.. py:property:: central_body_name
    :canonical: ansys.stk.core.stkobjects.astrogator.IStateCalcNumRevs.central_body_name
    :type: str

    Gets or sets the central body of the component.

.. py:property:: element_type
    :canonical: ansys.stk.core.stkobjects.astrogator.IStateCalcNumRevs.element_type
