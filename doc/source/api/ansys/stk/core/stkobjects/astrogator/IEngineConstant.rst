...
.. py:method:: enable_control_parameter(self, param: CONTROL_ENGINE_CONSTANT) -> None
    :canonical: ansys.stk.core.stkobjects.astrogator.IEngineConstant.enable_control_parameter
...
.. py:method:: disable_control_parameter(self, param: CONTROL_ENGINE_CONSTANT) -> None
    :canonical: ansys.stk.core.stkobjects.astrogator.IEngineConstant.disable_control_parameter
...
.. py:method:: is_control_parameter_enabled(self, param: CONTROL_ENGINE_CONSTANT) -> bool
    :canonical: ansys.stk.core.stkobjects.astrogator.IEngineConstant.is_control_parameter_enabled
