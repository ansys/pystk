...
.. py:currentmodule:: DesignER3BPSetup
...
.. py:property:: characteristic_time
    :canonical: ansys.stk.core.stkobjects.astrogator.DesignER3BPSetup.characteristic_time
    :type: float

    Get the characteristic time computed from the primary and secondary bodies.

.. py:property:: characteristic_velocity
    :canonical: ansys.stk.core.stkobjects.astrogator.DesignER3BPSetup.characteristic_velocity
    :type: float
...
.. py:method:: create_rotating_coordinate_system(self) -> None
    :canonical: ansys.stk.core.stkobjects.astrogator.DesignER3BPSetup.create_rotating_coordinate_system
