...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects.astrogator import IStateCalcLonOfPeriapsis
...
.. py:property:: coord_system_name
    :canonical: ansys.stk.core.stkobjects.astrogator.IStateCalcLonOfPeriapsis.coord_system_name
    :type: str

    Gets or sets the coordinate system within which the element is defined.

.. py:property:: element_type
    :canonical: ansys.stk.core.stkobjects.astrogator.IStateCalcLonOfPeriapsis.element_type
