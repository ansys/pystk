...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects.astrogator import IStateCalcDeltaRA
...
.. py:property:: central_body_name
    :canonical: ansys.stk.core.stkobjects.astrogator.IStateCalcDeltaRA.central_body_name
    :type: str

    Gets or sets the central body of the component.

.. py:property:: reference_type
    :canonical: ansys.stk.core.stkobjects.astrogator.IStateCalcDeltaRA.reference_type
    :type: "CALC_OBJECT_CENTRAL_BODY_REFERENCE"

    Gets or sets the central body's reference type.

.. py:property:: reference_body
    :canonical: ansys.stk.core.stkobjects.astrogator.IStateCalcDeltaRA.reference_body
    :type: str
