...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.RungeKutta2nd3rd.max_rel_err`
              - Gets or sets the maximum relative error used to control step size. Dimensionless.
            * - :py:attr:`~ansys.stk.core.stkobjects.astrogator.RungeKutta2nd3rd.max_abs_err`
...
.. py:property:: max_rel_err
    :canonical: ansys.stk.core.stkobjects.astrogator.RungeKutta2nd3rd.max_rel_err
    :type: float

    Gets or sets the maximum relative error used to control step size. Dimensionless.

.. py:property:: max_abs_err
    :canonical: ansys.stk.core.stkobjects.astrogator.RungeKutta2nd3rd.max_abs_err
    :type: float
