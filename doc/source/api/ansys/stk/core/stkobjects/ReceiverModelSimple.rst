    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.ReceiverModelSimple.supported_filters`
              - Do not use this property, as it is deprecated. Use FilterComponentLinking on IAgReceiverModelSimple instead. Gets an array of supported filter model names.
            * - :py:attr:`~ansys.stk.core.stkobjects.ReceiverModelSimple.filter`
              - Do not use this property, as it is deprecated. Use FilterComponentLinking on IAgReceiverModelSimple instead. Gets the current filter model.
