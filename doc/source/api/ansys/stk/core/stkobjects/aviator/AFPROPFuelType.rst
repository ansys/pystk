...
.. py:currentmodule:: AFPROPFuelType
...
.. tab-set::
    ...
    .. tab-item:: Members
        ...
        .. list-table::
            ...
            * - :py:attr:`~AFPROP_OVERRIDE`
              - Override the specific energy.

            * - :py:attr:`~AFPROP_JET_A`
              - Jet A fuel model based on AFPROP.

            * - :py:attr:`~AFPROP_JET_A1`
...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects.aviator import AFPROPFuelType
