...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects.aviator import IProcedureCollection
...
.. py:property:: count
    :canonical: ansys.stk.core.stkobjects.aviator.IProcedureCollection.count
    :type: int

    Returns the number of elements in a collection.

.. py:property:: _NewEnum
    :canonical: ansys.stk.core.stkobjects.aviator.IProcedureCollection._NewEnum
