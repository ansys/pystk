RELATIVE_SPEED_ALTITUDE_STOP_CONDITION
======================================
...
.. py:currentmodule:: RELATIVE_SPEED_ALTITUDE_STOP_CONDITION
...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects.aviator import RELATIVE_SPEED_ALTITUDE_STOP_CONDITION
