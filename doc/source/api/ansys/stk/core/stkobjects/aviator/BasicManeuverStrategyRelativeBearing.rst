...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.aviator.BasicManeuverStrategyRelativeBearing.cancel_tgt_position_vel`
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.aviator.BasicManeuverStrategyRelativeBearing.rel_bearing`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.aviator.BasicManeuverStrategyRelativeBearing.control_limit_horiz_accel`
              - Get the specified horizontal acceleration for a control limit mode of specify max horiz accel.
            * - :py:attr:`~ansys.stk.core.stkobjects.aviator.BasicManeuverStrategyRelativeBearing.compensate_for_coriolis_accel`
...
.. py:property:: rel_bearing
    :canonical: ansys.stk.core.stkobjects.aviator.BasicManeuverStrategyRelativeBearing.rel_bearing
    :type: typing.Any
...
.. py:property:: control_limit_horiz_accel
    :canonical: ansys.stk.core.stkobjects.aviator.BasicManeuverStrategyRelativeBearing.control_limit_horiz_accel
    :type: float

    Get the specified horizontal acceleration for a control limit mode of specify max horiz accel.

.. py:property:: compensate_for_coriolis_accel
    :canonical: ansys.stk.core.stkobjects.aviator.BasicManeuverStrategyRelativeBearing.compensate_for_coriolis_accel
    :type: bool
...
.. py:method:: cancel_tgt_position_vel(self) -> None
    :canonical: ansys.stk.core.stkobjects.aviator.BasicManeuverStrategyRelativeBearing.cancel_tgt_position_vel
