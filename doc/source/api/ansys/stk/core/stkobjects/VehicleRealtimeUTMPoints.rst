...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.VehicleRealtimeUTMPoints.add_position`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.VehicleRealtimeUTMPoints.add`
...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import VehicleRealtimeUTMPoints
...
.. py:method:: add_position(self, time: typing.Any, zoneStr: str, easting: float, northing: float, alt: float) -> None
    :canonical: ansys.stk.core.stkobjects.VehicleRealtimeUTMPoints.add_position
...
.. py:method:: add(self, time: typing.Any, zoneStr: str, easting: float, northing: float, alt: float, lonRate: float, latRate: float, altRate: float) -> None
    :canonical: ansys.stk.core.stkobjects.VehicleRealtimeUTMPoints.add
