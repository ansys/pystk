...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.ScenSpaceEnvironment.compute_saa_flux_intensity`
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.ScenSpaceEnvironment.radiation_environment`
              - Gets the radiation environment settings.
            * - :py:attr:`~ansys.stk.core.stkobjects.ScenSpaceEnvironment.graphics_3d`
...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import ScenSpaceEnvironment
...
.. py:method:: compute_saa_flux_intensity(self, channel: SPACE_ENVIRONMENT_SAA_CHANNEL, lat: float, lon: float, alt: float) -> float
    :canonical: ansys.stk.core.stkobjects.ScenSpaceEnvironment.compute_saa_flux_intensity
