...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.TargetGraphics.inherit_from_scenario`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.TargetGraphics.label_notes`
              - Notes attached to the object and displayed in the 2D and 3D Graphics windows.
            * - :py:attr:`~ansys.stk.core.stkobjects.TargetGraphics.marker_color`
              - The color in which the marker for the object is displayed.
            * - :py:attr:`~ansys.stk.core.stkobjects.TargetGraphics.label_color`
              - The color in which the label for the object is displayed.
            * - :py:attr:`~ansys.stk.core.stkobjects.TargetGraphics.is_object_graphics_visible`
...
.. py:property:: inherit_from_scenario
    :canonical: ansys.stk.core.stkobjects.TargetGraphics.inherit_from_scenario
    :type: bool

    Inheritable graphics attributes are inherited from the Scenario object instead of being set locally for the facility, place or target.

.. py:property:: color
    :canonical: ansys.stk.core.stkobjects.TargetGraphics.color
    :type: agcolor.Color

    The color in which the marker and label for the object is displayed in the 2D and 3D Graphics windows.

.. py:property:: marker_style
    :canonical: ansys.stk.core.stkobjects.TargetGraphics.marker_style
    :type: str

    The style of the marker representing the object in the 2D Graphics window. A member of the MarkerStyle enumeration.

.. py:property:: label_visible
    :canonical: ansys.stk.core.stkobjects.TargetGraphics.label_visible
    :type: bool
...
.. py:property:: use_inst_name_label
    :canonical: ansys.stk.core.stkobjects.TargetGraphics.use_inst_name_label
    :type: bool

    Use the name of the object as the label for the facility, place or target.

.. py:property:: label_name
    :canonical: ansys.stk.core.stkobjects.TargetGraphics.label_name
    :type: str
...
.. py:property:: marker_color
    :canonical: ansys.stk.core.stkobjects.TargetGraphics.marker_color
    :type: agcolor.Color

    The color in which the marker for the object is displayed.

.. py:property:: label_color
    :canonical: ansys.stk.core.stkobjects.TargetGraphics.label_color
    :type: agcolor.Color

    The color in which the label for the object is displayed.

.. py:property:: is_object_graphics_visible
    :canonical: ansys.stk.core.stkobjects.TargetGraphics.is_object_graphics_visible
    :type: bool
