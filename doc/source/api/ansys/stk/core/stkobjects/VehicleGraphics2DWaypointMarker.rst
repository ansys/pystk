...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.VehicleGraphics2DWaypointMarker.show_waypoint_markers`
              - Opt whether to display a marker in the 2D Graphics window at each waypoint along the vehicle's route.
            * - :py:attr:`~ansys.stk.core.stkobjects.VehicleGraphics2DWaypointMarker.show_turn_markers`
...
.. py:property:: show_waypoint_markers
    :canonical: ansys.stk.core.stkobjects.VehicleGraphics2DWaypointMarker.show_waypoint_markers
    :type: bool

    Opt whether to display a marker in the 2D Graphics window at each waypoint along the vehicle's route.

.. py:property:: show_turn_markers
    :canonical: ansys.stk.core.stkobjects.VehicleGraphics2DWaypointMarker.show_turn_markers
    :type: bool
