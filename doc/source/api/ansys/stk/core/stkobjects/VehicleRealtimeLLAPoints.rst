...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.VehicleRealtimeLLAPoints.add_position`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.VehicleRealtimeLLAPoints.add`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.VehicleRealtimeLLAPoints.add_position_batch`
              - Add data points without velocity information.
            * - :py:attr:`~ansys.stk.core.stkobjects.VehicleRealtimeLLAPoints.add_batch`
...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import VehicleRealtimeLLAPoints
...
.. py:method:: add_position(self, time: typing.Any, lat: float, lon: float, alt: float) -> None
    :canonical: ansys.stk.core.stkobjects.VehicleRealtimeLLAPoints.add_position
...
.. py:method:: add(self, time: typing.Any, lat: float, lon: float, alt: float, latRate: float, lonRate: float, altRate: float) -> None
    :canonical: ansys.stk.core.stkobjects.VehicleRealtimeLLAPoints.add
...
.. py:method:: add_position_batch(self, times: list, lats: list, lons: list, alts: list) -> None
    :canonical: ansys.stk.core.stkobjects.VehicleRealtimeLLAPoints.add_position_batch
...
.. py:method:: add_batch(self, times: list, lats: list, lons: list, alts: list, latRates: list, lonRates: list, altRates: list) -> None
    :canonical: ansys.stk.core.stkobjects.VehicleRealtimeLLAPoints.add_batch
