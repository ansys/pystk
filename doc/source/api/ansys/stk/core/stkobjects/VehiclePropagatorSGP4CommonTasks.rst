...
.. py:currentmodule:: VehiclePropagatorSGP4CommonTasks
...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.VehiclePropagatorSGP4CommonTasks.add_segs_from_file`
              - Search the specified file for elements matching the specified SSC number and adds them to the collection.
            * - :py:attr:`~ansys.stk.core.stkobjects.VehiclePropagatorSGP4CommonTasks.add_segs_from_online_source`
...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import VehiclePropagatorSGP4CommonTasks
...
.. py:method:: add_segs_from_file(self, sSCNumber: str, fileName: str) -> None
    :canonical: ansys.stk.core.stkobjects.VehiclePropagatorSGP4CommonTasks.add_segs_from_file
...
.. py:method:: add_segs_from_online_source(self, SSCNum: str) -> None
    :canonical: ansys.stk.core.stkobjects.VehiclePropagatorSGP4CommonTasks.add_segs_from_online_source
