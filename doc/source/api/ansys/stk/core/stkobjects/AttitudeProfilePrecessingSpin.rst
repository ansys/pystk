...
.. py:currentmodule:: AttitudeProfilePrecessingSpin
...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.AttitudeProfilePrecessingSpin.body`
...
.. py:property:: body
    :canonical: ansys.stk.core.stkobjects.AttitudeProfilePrecessingSpin.body
    :type: IDirection

    Get the spin axis in the body frame.

.. py:property:: inertial_precession
    :canonical: ansys.stk.core.stkobjects.AttitudeProfilePrecessingSpin.inertial_precession
    :type: IDirection
...
.. py:property:: smart_epoch
    :canonical: ansys.stk.core.stkobjects.AttitudeProfilePrecessingSpin.smart_epoch
