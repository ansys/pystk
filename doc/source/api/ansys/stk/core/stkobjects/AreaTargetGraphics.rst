...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.AreaTargetGraphics.centroid_visible`
              - Specify whether to display the centroid of the area target.
            * - :py:attr:`~ansys.stk.core.stkobjects.AreaTargetGraphics.label_visible`
              - Specify whether to display the label of the area target.
            * - :py:attr:`~ansys.stk.core.stkobjects.AreaTargetGraphics.use_inst_name_label`
              - Specify whether to use the name of the area target (as shown in the Object Browser) as its label.
            * - :py:attr:`~ansys.stk.core.stkobjects.AreaTargetGraphics.boundary_pts_visible`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.AreaTargetGraphics.boundary_visible`
              - Specify whether to display the area target's boundary.
            * - :py:attr:`~ansys.stk.core.stkobjects.AreaTargetGraphics.bounding_rect_visible`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.AreaTargetGraphics.is_object_graphics_visible`
...
.. py:property:: centroid_visible
    :canonical: ansys.stk.core.stkobjects.AreaTargetGraphics.centroid_visible
    :type: bool

    Specify whether to display the centroid of the area target.

.. py:property:: label_visible
    :canonical: ansys.stk.core.stkobjects.AreaTargetGraphics.label_visible
    :type: bool

    Specify whether to display the label of the area target.

.. py:property:: use_inst_name_label
    :canonical: ansys.stk.core.stkobjects.AreaTargetGraphics.use_inst_name_label
    :type: bool

    Specify whether to use the name of the area target (as shown in the Object Browser) as its label.

.. py:property:: boundary_pts_visible
    :canonical: ansys.stk.core.stkobjects.AreaTargetGraphics.boundary_pts_visible
    :type: bool
...
.. py:property:: boundary_visible
    :canonical: ansys.stk.core.stkobjects.AreaTargetGraphics.boundary_visible
    :type: bool

    Specify whether to display the area target's boundary.

.. py:property:: bounding_rect_visible
    :canonical: ansys.stk.core.stkobjects.AreaTargetGraphics.bounding_rect_visible
    :type: bool
...
.. py:property:: is_object_graphics_visible
    :canonical: ansys.stk.core.stkobjects.AreaTargetGraphics.is_object_graphics_visible
    :type: bool
