...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.VolumetricGraphics3DVolume.active_grid_points`
              - Get Active Grid Points values for Volume property in the 3D Graphics properties for Volumetric object.
            * - :py:attr:`~ansys.stk.core.stkobjects.VolumetricGraphics3DVolume.spatial_calculation_levels`
...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import VolumetricGraphics3DVolume
