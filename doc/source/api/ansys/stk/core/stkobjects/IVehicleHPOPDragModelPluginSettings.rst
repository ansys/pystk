...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import IVehicleHPOPDragModelPluginSettings
...
.. py:property:: available_properties
    :canonical: ansys.stk.core.stkobjects.IVehicleHPOPDragModelPluginSettings.available_properties
    :type: list
...
.. py:method:: get_property(self, path: str) -> typing.Any
    :canonical: ansys.stk.core.stkobjects.IVehicleHPOPDragModelPluginSettings.get_property
...
.. py:method:: set_property(self, path: str, val: typing.Any) -> None
    :canonical: ansys.stk.core.stkobjects.IVehicleHPOPDragModelPluginSettings.set_property
