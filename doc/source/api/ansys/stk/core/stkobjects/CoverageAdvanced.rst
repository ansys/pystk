...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.CoverageAdvanced.data_retention`
              - Data retention options can be all data or static data only.
            * - :py:attr:`~ansys.stk.core.stkobjects.CoverageAdvanced.auto_recompute`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.CoverageAdvanced.save_mode`
              - Specify whether accesses are saved with the coverage definition and, if not, whether they are recomputed on load.
            * - :py:attr:`~ansys.stk.core.stkobjects.CoverageAdvanced.region_access_acceleration`
              - Controls the use of region access computations to speedup overall coverage computations.
            * - :py:attr:`~ansys.stk.core.stkobjects.CoverageAdvanced.enable_light_time_delay`
              - Specify whether to take light time delay into account in the coverage computation.
            * - :py:attr:`~ansys.stk.core.stkobjects.CoverageAdvanced.event_detection`
              - Get the event detection strategy used in access computations.
            * - :py:attr:`~ansys.stk.core.stkobjects.CoverageAdvanced.sampling`
              - Get the sampling strategy used in access computations.
            * - :py:attr:`~ansys.stk.core.stkobjects.CoverageAdvanced.n_assets_satisfaction_threshold`
              - Number of assets for a valid access, per satisfaction type.
            * - :py:attr:`~ansys.stk.core.stkobjects.CoverageAdvanced.n_assets_satisfaction_type`
...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import CoverageAdvanced
...
.. py:property:: data_retention
    :canonical: ansys.stk.core.stkobjects.CoverageAdvanced.data_retention
    :type: COVERAGE_DATA_RETENTION

    Data retention options can be all data or static data only.

.. py:property:: auto_recompute
    :canonical: ansys.stk.core.stkobjects.CoverageAdvanced.auto_recompute
    :type: bool

    Opt whether to have STK automatically recompute accesses every time an object on which the coverage definition depends is updated.

.. py:property:: save_mode
    :canonical: ansys.stk.core.stkobjects.CoverageAdvanced.save_mode
    :type: DATA_SAVE_MODE
...
.. py:property:: enable_light_time_delay
    :canonical: ansys.stk.core.stkobjects.CoverageAdvanced.enable_light_time_delay
    :type: bool
...
.. py:property:: n_assets_satisfaction_threshold
    :canonical: ansys.stk.core.stkobjects.CoverageAdvanced.n_assets_satisfaction_threshold
    :type: int

    Number of assets for a valid access, per satisfaction type.

.. py:property:: n_assets_satisfaction_type
    :canonical: ansys.stk.core.stkobjects.CoverageAdvanced.n_assets_satisfaction_type
