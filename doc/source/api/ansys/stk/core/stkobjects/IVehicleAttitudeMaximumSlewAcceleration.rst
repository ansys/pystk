...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:meth:`~magnitude`
            * - :py:meth:`~per_axis_x_accel_enabled`
            * - :py:meth:`~per_axis_y_accel_enabled`
            * - :py:meth:`~per_axis_z_accel_enabled`
            * - :py:meth:`~per_axis_x_accel`
            * - :py:meth:`~per_axis_y_accel`
            * - :py:meth:`~per_axis_z_accel`
