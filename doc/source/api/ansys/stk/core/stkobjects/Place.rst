...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.Place.get_az_el_mask`
              - Get the az-el mask. A member of the AzElMaskType enumeration.
            * - :py:attr:`~ansys.stk.core.stkobjects.Place.get_az_el_mask_data`
              - Get az-el mask data.
            * - :py:attr:`~ansys.stk.core.stkobjects.Place.reset_az_el_mask`
              - Reset the az-el mask.
            * - :py:attr:`~ansys.stk.core.stkobjects.Place.set_az_el_mask`
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.Place.access_constraints`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.Place.local_time_offset`
            ...
            * - :py:attr:`~ansys.stk.core.stkobjects.Place.use_local_time_offset`
              - Opt whether to use a local time offset from GMT.
            * - :py:attr:`~ansys.stk.core.stkobjects.Place.use_terrain`
...
.. py:property:: height_above_ground
    :canonical: ansys.stk.core.stkobjects.Place.height_above_ground
    :type: None
...
.. py:property:: local_time_offset
    :canonical: ansys.stk.core.stkobjects.Place.local_time_offset
    :type: float
...
.. py:property:: position
    :canonical: ansys.stk.core.stkobjects.Place.position
    :type: IPosition
...
.. py:property:: use_local_time_offset
    :canonical: ansys.stk.core.stkobjects.Place.use_local_time_offset
    :type: bool

    Opt whether to use a local time offset from GMT.

.. py:property:: use_terrain
    :canonical: ansys.stk.core.stkobjects.Place.use_terrain
    :type: bool
