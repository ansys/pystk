...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects import IFacility
...
.. py:property:: use_local_time_offset
    :canonical: ansys.stk.core.stkobjects.IFacility.use_local_time_offset
    :type: bool

    Opt whether to use a local time offset from GMT.

.. py:property:: local_time_offset
    :canonical: ansys.stk.core.stkobjects.IFacility.local_time_offset
    :type: float

    The amount of the time offset from GMT, if this option is used. Uses Time Dimension.

.. py:property:: use_terrain
    :canonical: ansys.stk.core.stkobjects.IFacility.use_terrain
    :type: bool
...
.. py:property:: terrain_norm
    :canonical: ansys.stk.core.stkobjects.IFacility.terrain_norm
    :type: None
...
.. py:property:: height_above_ground
    :canonical: ansys.stk.core.stkobjects.IFacility.height_above_ground
    :type: None
...
.. py:property:: altitude_reference
    :canonical: ansys.stk.core.stkobjects.IFacility.altitude_reference
    :type: None
...
.. py:property:: save_terrain_mask_data_in_binary
    :canonical: ansys.stk.core.stkobjects.IFacility.save_terrain_mask_data_in_binary
    :type: bool

    Save terrain az-el mask data in binary.

.. py:property:: lighting_obstruction_model
    :canonical: ansys.stk.core.stkobjects.IFacility.lighting_obstruction_model
...
.. py:property:: lighting_max_step
    :canonical: ansys.stk.core.stkobjects.IFacility.lighting_max_step
    :type: float
...
.. py:property:: max_range_when_computing_az_el_mask
    :canonical: ansys.stk.core.stkobjects.IFacility.max_range_when_computing_az_el_mask
    :type: float
...
.. py:method:: set_az_el_mask(self, type: AZ_EL_MASK_TYPE, data: typing.Any) -> None
    :canonical: ansys.stk.core.stkobjects.IFacility.set_az_el_mask
...
.. py:method:: reset_az_el_mask(self) -> None
    :canonical: ansys.stk.core.stkobjects.IFacility.reset_az_el_mask
...
.. py:method:: get_az_el_mask(self) -> AZ_EL_MASK_TYPE
    :canonical: ansys.stk.core.stkobjects.IFacility.get_az_el_mask
...
.. py:method:: get_az_el_mask_data(self) -> typing.Any
    :canonical: ansys.stk.core.stkobjects.IFacility.get_az_el_mask_data
