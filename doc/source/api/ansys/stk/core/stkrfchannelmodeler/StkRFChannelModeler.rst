...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.rfcm.StkRFChannelModeler.duplicate_transceiver`
              - Duplicates a transceiver instance.
            * - :py:attr:`~ansys.stk.core.rfcm.StkRFChannelModeler.duplicate_analysis_configuration`
              - Duplicates an analysis configuration instance.
            * - :py:attr:`~ansys.stk.core.rfcm.StkRFChannelModeler.set_gpu_devices`
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.rfcm.StkRFChannelModeler.transceiver_collection`
              - Gets the collection of transceiver objects.
            * - :py:attr:`~ansys.stk.core.rfcm.StkRFChannelModeler.analysis_configuration_collection`
              - Gets the collection of analysis configurations.
            * - :py:attr:`~ansys.stk.core.rfcm.StkRFChannelModeler.supported_materials`
              - Gets the supported tileset materials
            * - :py:attr:`~ansys.stk.core.rfcm.StkRFChannelModeler.default_materials`
              - Gets the default tileset materials
            * - :py:attr:`~ansys.stk.core.rfcm.StkRFChannelModeler.compute_options`
              - Gets the compute options.
            * - :py:attr:`~ansys.stk.core.rfcm.StkRFChannelModeler.supported_gpu_properties_list`
...
.. code-block:: python
    ...
    from ansys.stk.core.rfcm import StkRFChannelModeler
...
.. py:property:: transceiver_collection
    :canonical: ansys.stk.core.rfcm.StkRFChannelModeler.transceiver_collection
    :type: StkRfcmTransceiverCollection

    Gets the collection of transceiver objects.

.. py:property:: analysis_configuration_collection
    :canonical: ansys.stk.core.rfcm.StkRFChannelModeler.analysis_configuration_collection
    :type: StkRfcmAnalysisConfigurationCollection

    Gets the collection of analysis configurations.

.. py:property:: supported_materials
    :canonical: ansys.stk.core.rfcm.StkRFChannelModeler.supported_materials
    :type: list

    Gets the supported tileset materials

.. py:property:: default_materials
    :canonical: ansys.stk.core.rfcm.StkRFChannelModeler.default_materials
    :type: list

    Gets the default tileset materials

.. py:property:: compute_options
    :canonical: ansys.stk.core.rfcm.StkRFChannelModeler.compute_options
    :type: StkRfcmComputeOptions

    Gets the compute options.

.. py:property:: supported_gpu_properties_list
    :canonical: ansys.stk.core.rfcm.StkRFChannelModeler.supported_gpu_properties_list
    :type: list
...
.. py:method:: duplicate_transceiver(self, transceiver: StkRfcmTransceiver) -> StkRfcmTransceiver
    :canonical: ansys.stk.core.rfcm.StkRFChannelModeler.duplicate_transceiver
...
.. py:method:: duplicate_analysis_configuration(self, analysis_configuration: StkRfcmAnalysisConfiguration) -> StkRfcmAnalysisConfiguration
    :canonical: ansys.stk.core.rfcm.StkRFChannelModeler.duplicate_analysis_configuration
...
.. py:method:: set_gpu_devices(self, gpu_device_ids: list) -> None
    :canonical: ansys.stk.core.rfcm.StkRFChannelModeler.set_gpu_devices
...
.. py:method:: construct_analysis(self, analysis_configuration_name: str) -> StkRfcmAnalysis
    :canonical: ansys.stk.core.rfcm.StkRFChannelModeler.construct_analysis
