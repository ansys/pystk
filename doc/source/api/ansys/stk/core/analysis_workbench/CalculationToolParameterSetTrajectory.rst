...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.analysis_workbench.CalculationToolParameterSetTrajectory.point`
              - Get the point for which trajectory representations are computed.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.CalculationToolParameterSetTrajectory.reference_system`
...
.. py:property:: point
    :canonical: ansys.stk.core.analysis_workbench.CalculationToolParameterSetTrajectory.point
    :type: IVectorGeometryToolPoint

    Get the point for which trajectory representations are computed.

.. py:property:: reference_system
    :canonical: ansys.stk.core.analysis_workbench.CalculationToolParameterSetTrajectory.reference_system
