...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create`
              - Create and register an interval list using specified name, description, and type.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_merged`
              - Create an interval list by merging two constituent interval lists using specified logical operation.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_filtered`
              - Create an interval list by filtering intervals from original interval list using specified filtering method.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_from_condition`
              - Create an interval list containing intervals during which specified condition is satisfied.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_scaled`
            ...
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_signaled`
            ...
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_time_offset`
              - Create an interval list defined by shifting the specified reference interval list by a fixed time offset.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.is_type_supported`
              - Return whether the specified type is supported.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_from_file`
              - Create an interval list based on specified interval file.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_fixed`
...
.. code-block:: python
    ...
    from ansys.stk.core.analysis_workbench import TimeToolTimeIntervalListFactory
...
.. py:method:: create(self, name: str, description: str, type: EventIntervalListType) -> ITimeToolTimeIntervalList
    :canonical: ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create
...
.. py:method:: create_merged(self, name: str, description: str) -> ITimeToolTimeIntervalList
    :canonical: ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_merged
...
.. py:method:: create_filtered(self, name: str, description: str) -> ITimeToolTimeIntervalList
    :canonical: ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_filtered
...
.. py:method:: create_from_condition(self, name: str, description: str) -> ITimeToolTimeIntervalList
    :canonical: ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_from_condition
...
.. py:method:: create_scaled(self, name: str, description: str) -> ITimeToolTimeIntervalList
    :canonical: ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_scaled
...
.. py:method:: create_signaled(self, name: str, description: str) -> ITimeToolTimeIntervalList
    :canonical: ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_signaled
...
.. py:method:: create_time_offset(self, name: str, description: str) -> ITimeToolTimeIntervalList
    :canonical: ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_time_offset
...
.. py:method:: is_type_supported(self, type: EventIntervalListType) -> bool
    :canonical: ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.is_type_supported
...
.. py:method:: create_from_file(self, name: str, description: str, file_path: str) -> ITimeToolTimeIntervalList
    :canonical: ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_from_file
...
.. py:method:: create_fixed(self, name: str, description: str) -> ITimeToolTimeIntervalList
    :canonical: ansys.stk.core.analysis_workbench.TimeToolTimeIntervalListFactory.create_fixed
