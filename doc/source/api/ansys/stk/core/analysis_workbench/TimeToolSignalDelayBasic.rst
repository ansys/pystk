...
.. py:class:: ansys.stk.core.analysis_workbench.TimeToolSignalDelayBasic
   ...
   Bases: :py:class:`~ansys.stk.core.analysis_workbench.IAnalysisWorkbenchSignalDelay`, :py:class:`~ansys.stk.core.analysis_workbench.IAnalysisWorkbenchComponent`
...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolSignalDelayBasic.reference_system`
            ...
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolSignalDelayBasic.signal_path_reference_system`
            ...
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolSignalDelayBasic.speed_option`
              - Get the speed option which determines whether to use the speed of light or a custom speed value.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolSignalDelayBasic.time_delay_convergence`
              - Get the time delay convergence which determines the accuracy of computed propagation time between the two locations.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.TimeToolSignalDelayBasic.transfer_speed`
...
.. py:property:: reference_system
    :canonical: ansys.stk.core.analysis_workbench.TimeToolSignalDelayBasic.reference_system
    :type: IVectorGeometryToolSystem

    Get the custom reference system which is used as a reference for signal path if the signal path reference option is set to Custom.

.. py:property:: signal_path_reference_system
    :canonical: ansys.stk.core.analysis_workbench.TimeToolSignalDelayBasic.signal_path_reference_system
    :type: SignalPathReferenceSystem

    Get the type of signal path reference system which can be set to use STK Access default (see STK Help for further details), Solar system barycenter inertial reference, central body inertial reference or custom reference system...

.. py:property:: speed_option
    :canonical: ansys.stk.core.analysis_workbench.TimeToolSignalDelayBasic.speed_option
    :type: SpeedType

    Get the speed option which determines whether to use the speed of light or a custom speed value.

.. py:property:: time_delay_convergence
    :canonical: ansys.stk.core.analysis_workbench.TimeToolSignalDelayBasic.time_delay_convergence
    :type: float

    Get the time delay convergence which determines the accuracy of computed propagation time between the two locations.

.. py:property:: transfer_speed
    :canonical: ansys.stk.core.analysis_workbench.TimeToolSignalDelayBasic.transfer_speed
    :type: float
