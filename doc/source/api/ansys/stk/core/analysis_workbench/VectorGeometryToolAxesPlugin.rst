...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.reset`
              - Reset the plugin.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.set_property`
            ...
            * - :py:attr:`~ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.get_property`
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.prog_id`
              - A programmatic ID associated with the component.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.display_name`
              - Plugin's Display Name associated with the COM plugin.
            * - :py:attr:`~ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.available_properties`
...
.. py:property:: prog_id
    :canonical: ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.prog_id
    :type: str

    A programmatic ID associated with the component.

.. py:property:: display_name
    :canonical: ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.display_name
    :type: str

    Plugin's Display Name associated with the COM plugin.

.. py:property:: available_properties
    :canonical: ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.available_properties
    :type: list
...
.. py:method:: reset(self) -> None
    :canonical: ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.reset
...
.. py:method:: set_property(self, name: str, value: str) -> None
    :canonical: ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.set_property
...
.. py:method:: get_property(self, name: str) -> str
    :canonical: ansys.stk.core.analysis_workbench.VectorGeometryToolAxesPlugin.get_property
