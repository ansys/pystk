...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolScalarSurfaceDistanceBetweenPoints.differencing_time_step`
...
.. py:property:: surface_central_body
    :canonical: ansys.stk.core.vgt.CalculationToolScalarSurfaceDistanceBetweenPoints.surface_central_body
    :type: str

    Central body on which the surface distance between points is to be calculated.

.. py:property:: differencing_time_step
    :canonical: ansys.stk.core.vgt.CalculationToolScalarSurfaceDistanceBetweenPoints.differencing_time_step
    :type: float
