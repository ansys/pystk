...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolSamplingRelativeTolerance.minimum_time_step`
              - Get the minimum allowed time step.
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolSamplingRelativeTolerance.maximum_time_step`
              - Get the maximum allowed time step.
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolSamplingRelativeTolerance.step_at_boundaries`
              - Get the step taken at boundaries of discontinuity or availability.
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolSamplingRelativeTolerance.relative_tolerance`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolSamplingRelativeTolerance.absolute_tolerance`
...
.. code-block:: python
    ...
    from ansys.stk.core.vgt import CalculationToolSamplingRelativeTolerance
...
.. py:property:: minimum_time_step
    :canonical: ansys.stk.core.vgt.CalculationToolSamplingRelativeTolerance.minimum_time_step
    :type: float

    Get the minimum allowed time step.

.. py:property:: maximum_time_step
    :canonical: ansys.stk.core.vgt.CalculationToolSamplingRelativeTolerance.maximum_time_step
    :type: float

    Get the maximum allowed time step.

.. py:property:: step_at_boundaries
    :canonical: ansys.stk.core.vgt.CalculationToolSamplingRelativeTolerance.step_at_boundaries
    :type: float

    Get the step taken at boundaries of discontinuity or availability.

.. py:property:: relative_tolerance
    :canonical: ansys.stk.core.vgt.CalculationToolSamplingRelativeTolerance.relative_tolerance
    :type: float

    Get the relative tolerance which determines acceptable difference between predicted and actual changes in values of sampled data over a step relative to the sampled values.

.. py:property:: absolute_tolerance
    :canonical: ansys.stk.core.vgt.CalculationToolSamplingRelativeTolerance.absolute_tolerance
    :type: float
