...
.. py:currentmodule:: PlaneReference
...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.PlaneReference.set_path`
              - Set a new plane using a specified path.
            * - :py:attr:`~ansys.stk.core.vgt.PlaneReference.set_plane`
              - Set a new plane.
            * - :py:attr:`~ansys.stk.core.vgt.PlaneReference.get_plane`
              - Return the actual plane object behind the reference. Use IAgCrdn.IsValid to test the validity of the returned object.
            * - :py:attr:`~ansys.stk.core.vgt.PlaneReference.has_cyclic_dependency`
...
.. code-block:: python
    ...
    from ansys.stk.core.vgt import PlaneReference
...
.. py:method:: set_path(self, path: str) -> None
    :canonical: ansys.stk.core.vgt.PlaneReference.set_path
...
.. py:method:: set_plane(self, plane: IVectorGeometryToolPlane) -> None
    :canonical: ansys.stk.core.vgt.PlaneReference.set_plane
...
.. py:method:: get_plane(self) -> IVectorGeometryToolPlane
    :canonical: ansys.stk.core.vgt.PlaneReference.get_plane
...
.. py:method:: has_cyclic_dependency(self, plane: IVectorGeometryToolPlane) -> bool
    :canonical: ansys.stk.core.vgt.PlaneReference.has_cyclic_dependency
