...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeArraySignaled.original_time_array`
              - The original time array.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeArraySignaled.signal_sense`
              - The direction of the signal, whether you are Transmitting or Receiving from the Base Clock Location.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeArraySignaled.base_clock_location`
              - The base clock location, which is a point from VGT.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeArraySignaled.target_clock_location`
              - The target clock location, which is a point from VGT.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeArraySignaled.signal_delay`
...
.. code-block:: python
    ...
    from ansys.stk.core.vgt import TimeToolTimeArraySignaled
...
.. py:property:: original_time_array
    :canonical: ansys.stk.core.vgt.TimeToolTimeArraySignaled.original_time_array
...
.. py:property:: base_clock_location
    :canonical: ansys.stk.core.vgt.TimeToolTimeArraySignaled.base_clock_location
    :type: IVectorGeometryToolPoint

    The base clock location, which is a point from VGT.

.. py:property:: target_clock_location
    :canonical: ansys.stk.core.vgt.TimeToolTimeArraySignaled.target_clock_location
    :type: IVectorGeometryToolPoint

    The target clock location, which is a point from VGT.

.. py:property:: signal_delay
    :canonical: ansys.stk.core.vgt.TimeToolTimeArraySignaled.signal_delay
