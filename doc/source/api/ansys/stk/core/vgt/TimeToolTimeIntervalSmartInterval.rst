...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.set_implicit_interval`
              - Set the reference interval and changes the state to Implicit.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.find_start_time`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.find_stop_time`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.get_start_epoch`
              - Return a copy of the start epoch. Changes to the epoch will not affect the state of the interval.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.set_start_epoch`
              - Set a start of the interval using specified epoch component.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.get_stop_epoch`
              - Return a copy of the stop epoch. Changes to the epoch will not affect the state of the interval.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.set_stop_epoch`
              - Set a stop of the interval using specified epoch component.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.set_explicit_interval`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.set_start_and_stop_epochs`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.set_start_and_stop_times`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.set_start_epoch_and_duration`
              - Set the interval's start epoch and the interval's duration.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.set_start_time_and_duration`
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.reference_interval`
              - The reference interval used to compute start/stop times of this interval if the state of the interval is set to implicit.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.duration_as_string`
              - The duration of the interval.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.state`
...
.. code-block:: python
    ...
    from ansys.stk.core.vgt import TimeToolTimeIntervalSmartInterval
...
.. py:property:: reference_interval
    :canonical: ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.reference_interval
    :type: ITimeToolTimeInterval

    The reference interval used to compute start/stop times of this interval if the state of the interval is set to implicit.

.. py:property:: duration_as_string
    :canonical: ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.duration_as_string
    :type: str
...
.. py:method:: find_start_time(self) -> typing.Any
    :canonical: ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.find_start_time
...
.. py:method:: find_stop_time(self) -> typing.Any
    :canonical: ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.find_stop_time
...
.. py:method:: get_start_epoch(self) -> TimeToolInstantSmartEpoch
    :canonical: ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.get_start_epoch
...
.. py:method:: get_stop_epoch(self) -> TimeToolInstantSmartEpoch
    :canonical: ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.get_stop_epoch
...
.. py:method:: set_explicit_interval(self, start: typing.Any, stop: typing.Any) -> None
    :canonical: ansys.stk.core.vgt.TimeToolTimeIntervalSmartInterval.set_explicit_interval
