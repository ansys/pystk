...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.VectorGeometryToolVectorPlugin.reset`
              - Reset the plugin.
            * - :py:attr:`~ansys.stk.core.vgt.VectorGeometryToolVectorPlugin.set_property`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.VectorGeometryToolVectorPlugin.get_property`
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.VectorGeometryToolVectorPlugin.available_properties`
...
.. code-block:: python
    ...
    from ansys.stk.core.vgt import VectorGeometryToolVectorPlugin
...
.. py:property:: display_name
    :canonical: ansys.stk.core.vgt.VectorGeometryToolVectorPlugin.display_name
    :type: str

    Plugin's Display Name associated with the COM plugin.

.. py:property:: available_properties
    :canonical: ansys.stk.core.vgt.VectorGeometryToolVectorPlugin.available_properties
    :type: list
...
.. py:method:: reset(self) -> None
    :canonical: ansys.stk.core.vgt.VectorGeometryToolVectorPlugin.reset
...
.. py:method:: set_property(self, name: str, value: str) -> None
    :canonical: ansys.stk.core.vgt.VectorGeometryToolVectorPlugin.set_property
...
.. py:method:: get_property(self, name: str) -> str
    :canonical: ansys.stk.core.vgt.VectorGeometryToolVectorPlugin.get_property
