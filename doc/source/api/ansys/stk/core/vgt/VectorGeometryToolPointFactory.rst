...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.VectorGeometryToolPointFactory.create_point_plugin_from_display_name`
              - Create a point component based on a COM point plugin. For information how to implement and register VGT plugins, see.
            * - :py:attr:`~ansys.stk.core.vgt.VectorGeometryToolPointFactory.create_point_fixed_on_central_body`
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.VectorGeometryToolPointFactory.available_point_plugin_display_names`
...
.. py:property:: available_point_plugin_display_names
    :canonical: ansys.stk.core.vgt.VectorGeometryToolPointFactory.available_point_plugin_display_names
    :type: list
...
.. py:method:: create_point_plugin_from_display_name(self, pointName: str, description: str, displayName: str) -> IVectorGeometryToolPoint
    :canonical: ansys.stk.core.vgt.VectorGeometryToolPointFactory.create_point_plugin_from_display_name
...
.. py:method:: create_point_fixed_on_central_body(self, pointName: str, description: str, longitude: typing.Any, latitude: typing.Any, altitude: float, referenceShape: CRDN_REFERENCE_SHAPE_TYPE) -> IVectorGeometryToolPoint
    :canonical: ansys.stk.core.vgt.VectorGeometryToolPointFactory.create_point_fixed_on_central_body
