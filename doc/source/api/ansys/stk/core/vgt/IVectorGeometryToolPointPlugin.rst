...
.. code-block:: python
    ...
    from ansys.stk.core.vgt import IVectorGeometryToolPointPlugin
...
.. py:property:: prog_id
    :canonical: ansys.stk.core.vgt.IVectorGeometryToolPointPlugin.prog_id
    :type: str

    A programmatic ID associated with the component.

.. py:property:: display_name
    :canonical: ansys.stk.core.vgt.IVectorGeometryToolPointPlugin.display_name
    :type: str

    Plugin's Display Name associated with the COM plugin.

.. py:property:: available_properties
    :canonical: ansys.stk.core.vgt.IVectorGeometryToolPointPlugin.available_properties
    :type: list
