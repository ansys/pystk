...
.. py:currentmodule:: ICalculationToolSamplingMethodFactory
...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolSamplingMethodFactory.create_fixed_step`
              - Create a fixed time step sampling definition.
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolSamplingMethodFactory.create_curvature_tolerance`
              - Create a curvature tolerance sampling definition. Curvature tolerance uses changes in slope between samples.
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolSamplingMethodFactory.create_relative_tolerance`
