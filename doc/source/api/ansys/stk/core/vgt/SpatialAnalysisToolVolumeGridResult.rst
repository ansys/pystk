...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.SpatialAnalysisToolVolumeGridResult.epoch`
              - Epoch of returned volumetric data.
            * - :py:attr:`~ansys.stk.core.vgt.SpatialAnalysisToolVolumeGridResult.size_i`
              - Number of grid point coordinates representing first dimension of volume grid.
            * - :py:attr:`~ansys.stk.core.vgt.SpatialAnalysisToolVolumeGridResult.size_j`
...
.. code-block:: python
    ...
    from ansys.stk.core.vgt import SpatialAnalysisToolVolumeGridResult
...
.. py:property:: epoch
    :canonical: ansys.stk.core.vgt.SpatialAnalysisToolVolumeGridResult.epoch
    :type: typing.Any

    Epoch of returned volumetric data.

.. py:property:: size_i
    :canonical: ansys.stk.core.vgt.SpatialAnalysisToolVolumeGridResult.size_i
    :type: int

    Number of grid point coordinates representing first dimension of volume grid.

.. py:property:: size_j
    :canonical: ansys.stk.core.vgt.SpatialAnalysisToolVolumeGridResult.size_j
    :type: int

    Number of grid point coordinates representing second dimension of volume grid.

.. py:property:: size_k
    :canonical: ansys.stk.core.vgt.SpatialAnalysisToolVolumeGridResult.size_k
    :type: int
