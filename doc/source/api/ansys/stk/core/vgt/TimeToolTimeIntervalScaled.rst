...
.. py:currentmodule:: TimeToolTimeIntervalScaled
...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalScaled.original_interval`
              - The original interval.
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalScaled.absolute_increment`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalScaled.relative_increment`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.TimeToolTimeIntervalScaled.use_absolute_increment`
...
.. code-block:: python
    ...
    from ansys.stk.core.vgt import TimeToolTimeIntervalScaled
...
.. py:property:: original_interval
    :canonical: ansys.stk.core.vgt.TimeToolTimeIntervalScaled.original_interval
    :type: ITimeToolTimeInterval

    The original interval.

.. py:property:: absolute_increment
    :canonical: ansys.stk.core.vgt.TimeToolTimeIntervalScaled.absolute_increment
    :type: float

    The absolute increment value which creates a interval by expanding (or shortening if negative) the original interval by shifting its start/stop times equally by half of specified increment value.

.. py:property:: relative_increment
    :canonical: ansys.stk.core.vgt.TimeToolTimeIntervalScaled.relative_increment
    :type: float

    The relative increment value from which absolute increment is obtained by multiplying relative value by interval duration...

.. py:property:: use_absolute_increment
    :canonical: ansys.stk.core.vgt.TimeToolTimeIntervalScaled.use_absolute_increment
    :type: bool
