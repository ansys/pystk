...
.. py:currentmodule:: ICalculationToolScalarAverage
...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.set_offsets`
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.input_scalar`
              - The input scalar calculation.
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.compute_as_average`
              - Specify whether the resulting integral value is divided by its time span to generate average value instead of integral.
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.integration_window_type`
              - The integration window, or accumulation, type.
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.start_offset`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.stop_offset`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.use_custom_time_limits`
              - Specify whether to use custom interval list (CustomTimeLimits).
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.custom_time_limits`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.save_data_option`
              - Set the value to determine if computed time of extremum is saved/loaded, or recomputed on load if necessary.
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.interpolation`
              - Specify whether to use Lagrange or Hermite interpolation. See STK help on interpolation.
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.sampling`
              - The Sampling definition, which can use a fixed step, relative tolerance or curvature tolerance. Relative tolerance uses a combination of relative and absolute changes in scalar values between samples...
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.integral`
              - The numerical integration method.
            * - :py:attr:`~ansys.stk.core.vgt.ICalculationToolScalarAverage.keep_constant_outside_time_limits`
...
.. py:method:: set_offsets(self, startOffset: float, stopOffset: float) -> None
    :canonical: ansys.stk.core.vgt.ICalculationToolScalarAverage.set_offsets
