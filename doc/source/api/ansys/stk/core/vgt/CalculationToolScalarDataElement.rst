...
.. tab-set::
    ...
    .. tab-item:: Methods
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolScalarDataElement.set`
              - Set the data provider and the element name.
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolScalarDataElement.set_with_group`
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolScalarDataElement.data_provider`
              - The name of the data provider.
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolScalarDataElement.element_name`
              - The name of the data element within the data provider.
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolScalarDataElement.group`
            ...
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolScalarDataElement.interpolation`
              - Specify whether to use Lagrange or Hermite interpolation. See STK help on interpolation.
            * - :py:attr:`~ansys.stk.core.vgt.CalculationToolScalarDataElement.sampling`
...
.. py:property:: data_provider
    :canonical: ansys.stk.core.vgt.CalculationToolScalarDataElement.data_provider
    :type: str

    The name of the data provider.

.. py:property:: element_name
    :canonical: ansys.stk.core.vgt.CalculationToolScalarDataElement.element_name
    :type: str

    The name of the data element within the data provider.

.. py:property:: group
    :canonical: ansys.stk.core.vgt.CalculationToolScalarDataElement.group
    :type: str
...
.. py:property:: sampling
    :canonical: ansys.stk.core.vgt.CalculationToolScalarDataElement.sampling
    :type: IAnalysisWorkbenchSampling

    Relative tolerance uses a combination of relative and absolute changes in scalar values between samples. Curvature tolerance also uses changes in slope between samples.

.. py:property:: use_samples
    :canonical: ansys.stk.core.vgt.CalculationToolScalarDataElement.use_samples
    :type: bool
