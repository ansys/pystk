...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects.astrogator import ISRPNPlate
...
.. py:property:: atmos_altitude
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPNPlate.atmos_altitude
    :type: float
...
.. py:property:: mean_flux
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPNPlate.mean_flux
    :type: float

    Gets or sets the mean solar flux at 1 au (W/m^2).

.. py:property:: luminosity
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPNPlate.luminosity
    :type: float
...
.. py:property:: include_boundary_mitigation
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPNPlate.include_boundary_mitigation
    :type: bool
...
.. py:property:: use_sun_central_body_file_values
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPNPlate.use_sun_central_body_file_values
    :type: bool

    True if solar values should come from the Sun.cb file.

.. py:property:: solar_radius
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPNPlate.solar_radius
    :type: float
...
.. py:property:: n_plate_definition_file
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPNPlate.n_plate_definition_file
    :type: str
