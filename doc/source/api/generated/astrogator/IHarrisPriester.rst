...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects.astrogator import IHarrisPriester
...
.. py:property:: use_approximate_altitude
    :canonical: ansys.stk.core.stkobjects.astrogator.IHarrisPriester.use_approximate_altitude
    :type: bool

    True if using approximate altitude formula.

.. py:property:: computes_temperature
    :canonical: ansys.stk.core.stkobjects.astrogator.IHarrisPriester.computes_temperature
    :type: bool

    Flag indicates whether this model computes temperature.

.. py:property:: computes_pressure
    :canonical: ansys.stk.core.stkobjects.astrogator.IHarrisPriester.computes_pressure
    :type: bool
...
.. py:property:: f_10_p7_avg
    :canonical: ansys.stk.core.stkobjects.astrogator.IHarrisPriester.f_10_p7_avg
    :type: float
...
.. py:property:: atmos_data_filename
    :canonical: ansys.stk.core.stkobjects.astrogator.IHarrisPriester.atmos_data_filename
    :type: str
...
.. py:property:: drag_model_plugin_name
    :canonical: ansys.stk.core.stkobjects.astrogator.IHarrisPriester.drag_model_plugin_name
    :type: str
...
.. py:property:: variable_area_history_file
    :canonical: ansys.stk.core.stkobjects.astrogator.IHarrisPriester.variable_area_history_file
    :type: str

    Drag variable area history file.

.. py:property:: n_plate_definition_file
    :canonical: ansys.stk.core.stkobjects.astrogator.IHarrisPriester.n_plate_definition_file
    :type: str
