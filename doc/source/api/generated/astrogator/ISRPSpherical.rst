...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects.astrogator import ISRPSpherical
...
.. py:property:: atmos_altitude
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPSpherical.atmos_altitude
    :type: float
...
.. py:property:: shadow_model
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPSpherical.shadow_model
    :type: "SHADOW_MODEL"

    Gets or sets the shadow model type.

.. py:property:: sun_position
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPSpherical.sun_position
    :type: "SUN_POSITION"
...
.. py:property:: mean_flux
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPSpherical.mean_flux
    :type: float

    Gets or sets the mean solar flux at 1 au (W/m^2).

.. py:property:: luminosity
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPSpherical.luminosity
    :type: float

    Gets or sets the luminosity of sun. Dimensionless.

.. py:property:: solar_force_method
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPSpherical.solar_force_method
    :type: "SOLAR_FORCE_METHOD"

    Gets or sets the solar force method.

.. py:property:: include_boundary_mitigation
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPSpherical.include_boundary_mitigation
    :type: bool
...
.. py:property:: use_sun_central_body_file_values
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPSpherical.use_sun_central_body_file_values
    :type: bool

    True if solar values should come from the Sun.cb file.

.. py:property:: solar_radius
    :canonical: ansys.stk.core.stkobjects.astrogator.ISRPSpherical.solar_radius
    :type: float
