...
This example provides the Python implementation for computing descriptive statistics access measurements grouped by `Asset Name`.

TODO: add snippet for this example here

This produces the following data table:

.. image:: img/pandas-stats2.png
...
.. literalinclude:: /../../tests/doc_snippets_tests/data_analysis/data_analysis_snippets.py
  ...
  :end-at: plt.tick_params(axis='y', labelsize=15)
  :dedent:
