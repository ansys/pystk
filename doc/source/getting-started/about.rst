...
achieved using the `win32com`_ or `comtypes`_ Python modules. With the release of STK 12.1, Python wrappers were auto-generated by using `ctypes`_ to directly call shared libraries.
