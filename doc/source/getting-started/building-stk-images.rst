...
.. grid:: 2
    ...
    .. grid-item-card:: Dockerfiles for Linux :fab:`linux` :fab:`ubuntu`
...
.. code-block:: text
    ...
    docker run \
      ...
      --name stk-python3.10 \
      --entrypoint /bin/bash \
      ansys/stk:dev-ubuntu22.04-python3.10

In this example, a container is created from the
``ansys/stk:dev-ubuntu22.04-python3.10`` Docker image. It runs in detached mode
