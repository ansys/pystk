...
} = require("../../external/pyright/build/lib/webpack");

const outPath = path.resolve(__dirname, "dist");
const typeshedFallback = path.resolve(
  __dirname,
  "..",
  "..",
  "external",
...
module.exports = (_, { mode }) => {
  return {
    context: __dirname,
    entry: {
      api_migration_tool: "./src/apiMigrationTool.ts",
    },
    target: "node",
    output: {
      filename: "[name].js",
      ...
      devtoolModuleFilenameTemplate:
        mode === "development"
          ? "../[resource-path]"
          : monorepoResourceNameMapper("pyright"),
      clean: true,
    },
