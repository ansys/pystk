...
.. tab-set::
    ...
    .. tab-item:: Properties
        ...
        .. list-table::
            ...
            * - :py:attr:`~ansys.stk.core.graphics.BatchPrimitiveIndex.index`
              - The index of the item contained by the Primitive.
            * - :py:attr:`~ansys.stk.core.graphics.BatchPrimitiveIndex.primitive`
...
.. py:property:: index
    :canonical: ansys.stk.core.graphics.BatchPrimitiveIndex.index
    :type: int

    The index of the item contained by the Primitive.

.. py:property:: primitive
    :canonical: ansys.stk.core.graphics.BatchPrimitiveIndex.primitive
    :type: IPrimitive
