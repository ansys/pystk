...
.. code-block:: python
    ...
    from ansys.stk.core.stkobjects.astrogator import YarkovskyFunc
...
.. py:property:: a2
    :canonical: ansys.stk.core.stkobjects.astrogator.YarkovskyFunc.a2
    :type: float

    Velocity tangent acceleration multiplier. Uses acceleration dimension.

.. py:property:: a3
    :canonical: ansys.stk.core.stkobjects.astrogator.YarkovskyFunc.a3
    :type: float
