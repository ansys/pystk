...
from agi.stk12.plugins.utplugin         import IAgUtPluginConfig, AgEUtLogMsgType, AgEUtTimeScale, AgEUtFrame
from agi.stk12.plugins.stkplugin        import AgStkPluginSite
from agi.stk12.utilities.exceptions     import STKInvalidCastError
from agi.stk12.plugins.asplugin         import AgEAsEphemInterpolationMethod, AgEAsCovRep, AgEAsEphemFileDistanceUnit, AgEAsEphemFileTimeUnit
...
class CAgAsEphemFileReaderPlugin(object):
    ...
    def ReadEphemeris(self, Result:'IAgAsEphemFileReaderPluginResultEphem'):
        ...
        for Line in Lines[6:]:
            ...
            if Result.AddEphemerisOnDate(AgEUtTimeScale.eUtTimeScaleUTC, Time.year, Time.month, Time.day, 
