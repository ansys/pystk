stk.v.7.0
BEGIN Scenario
    Name            Bug_Access_SensorFOV-AT-LT_24088

BEGIN Epoch
    Epoch        1 Dec 2005 12:00:00.000000000

END Epoch

BEGIN Interval

Start               1 Dec 2005 12:00:00.000000000
Stop                2 Dec 2005 12:00:00.000000000
...
BEGIN Animation
    ...
    EndTime            1 Dec 2005 16:00:00.000000000
    Direction          Forward
    UpdateDelta        60.0000
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN SoftVTR
            OutputFormat     BMP
            Directory        C:\DOCUME~1\woodburn\LOCALS~1\Temp
            BaseName         Frame
            Digits           4
            Frame            0
    ...
    BEGIN Map
        ...
        BEGIN MapAttributes
            ...
            OrthoDisplayDistance 20000000.000000
            TransformTrajectory  On
            EquatorialRadius     3397000.000000
            PrimaryBody          Mars
            SecondaryBody        Sun
            BackgroundColor      #000000
            LatLonLines          On
...
#			order: kind:domain:country:catagory:subCatagory:specific:xtra ( -1 = * )
    ...
    BEGIN PODS
        ...
        ScratchDirectory      C:\DOCUME~1\woodburn\LOCALS~1\Temp
        CleanupFlag           True
        PODSMessages          True
        TDMaxObs              1000
        TDMaxPB               168
