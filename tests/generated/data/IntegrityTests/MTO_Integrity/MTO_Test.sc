...
END MapData
    ...
    BEGIN LaserCAT
		Mode                     TargetObject
		StartTime                1 Jul 2005 12:00:00.000000000
		StopTime                 1 Jul 2005 16:00:00.000000000
    ...
    FileType         Ephemeris
    Directory        C:\Documents and Settings\bgilbert\My Documents\STK 9
    UseTimePeriod    No
...
<OBJECT Class = "RFEnvironment" Name = "STK_RF_Environment">
    ...
    <OBJECT Class = "string" Name = "RainOutagePercent"> &quot;0.001&quot; </OBJECT>
    <OBJECT Class = "bool" Name = "ReadOnly"> False </OBJECT>
...
#			order: kind:domain:country:catagory:subCatagory:specific:xtra ( -1 = * )
    ...
    BEGIN PODS
        ...
        ScratchDirectory      C:\DOCUME~1\bgilbert\LOCALS~1\Temp
        CleanupFlag           True
        PODSMessages          True
        TDMaxObs              1000
        TDMaxPB               168
...
BEGIN References
    Instance *
        *
        Satellite/Geo1/Sensor/A_Sensor
    END Instance
    Instance MTO/A_MTO
    END Instance
    Instance MTO/Defaults1
    END Instance
    Instance Satellite/Geo1
        Satellite/Geo1
        Satellite/Geo1/Sensor/A_Sensor
    END Instance
    Instance Satellite/Geo1/Sensor/A_Sensor
        Satellite/Geo1/Sensor/A_Sensor
    END Instance
END References
