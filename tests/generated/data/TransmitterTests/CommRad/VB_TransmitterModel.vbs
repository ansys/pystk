...
'		Input Parameters
	...
	ac = ac+1
  	...
  	argStr(ac) = "ArgumentType = Input ; Name = DateUTC ; ArgumentName = dateStr"
	ac = ac+1
...
'	Note: This example is for fixed parameters, but these can vary at each time step
	...
	Dim UseCDMASpreadGain, CDMAGain, UsePSD
...
'	range = Sqr((xmtrX-rcX)^2 + (xmtrY-rcY)^2 + (xmtrZ-rcZ)^2)
	...
	returnValue(VB_TransmitterModel_Outputs.UsePSD)           = 0
