...
class Sensor(CodeSnippetsTestBase):
    ...
    def test_ConfigureAndComputeSensorSwath(self):
        ...
        (clr.Convert(Sensor.m_Satellite, ISatellite)).set_propagator_type(VEHICLE_PROPAGATOR_TYPE.PROPAGATOR_TWO_BODY)
    ...
    def ConfigureSensorVOProjectionTimeVarying(self, sensorVo: "ISensorGraphics3D"):
        ...
        elem2: "ISensorGraphics3DProjectionElement" = sensorVo.space_projection_intervals.add()
        elem2.distance = 2000.0
        elem2.time = "1 Jan 2012 16:00:00.000"
        elem3: "ISensorGraphics3DProjectionElement" = sensorVo.space_projection_intervals.add()
