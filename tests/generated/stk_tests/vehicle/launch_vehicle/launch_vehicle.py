...
class EarlyBoundTests(TestBase):
    ...
    def InitHelper():
        ...
        EarlyBoundTests.AG_LV = LaunchVehicle(
            TestBase.Application.current_scenario.children.new(STKObjectType.LAUNCH_VEHICLE, "Pershing")
        )
    ...
    def test_STKObject(self):
        EarlyBoundTests.AG_LV.set_trajectory_type(PropagatorType.SIMPLE_ASCENT)
        Assert.assertEqual(PropagatorType.SIMPLE_ASCENT, EarlyBoundTests.AG_LV.trajectory_type)
    ...
    def test_BasicAttitude(self):
        ...
        while iIndex < len(arTypes):
            ...
            eType2: "VehicleAttitude" = EarlyBoundTests.AG_LV.attitude_type
    ...
    def test_BasicTrajectory(self):
        ...
        while iIndex < len(arTypes):
            ...
            eType2: "PropagatorType" = EarlyBoundTests.AG_LV.trajectory_type
            Assert.assertEqual(eType, eType2)
            # Trajectory
    ...
    def test_GfxAttributesAccess(self):
        ...
        oHelper.Run(
            VehicleGraphics2DAttributesAccess(EarlyBoundTests.AG_LV.graphics.attributes),
    ...
    def test_GfxAttributesCustom(self):
        ...
        oHelper.Run(
            VehicleGraphics2DAttributesCustom(EarlyBoundTests.AG_LV.graphics.attributes), GfxAttributesType.eTrajectory
        )

        custom: "VehicleGraphics2DAttributesCustom" = clr.CastAs(
            EarlyBoundTests.AG_LV.graphics.attributes, VehicleGraphics2DAttributesCustom
        )
    ...
    def test_GfxAttributesTimeComponents(self):
        ...
        oHelper.Run(
            VehicleGraphics2DAttributesTimeComponents(EarlyBoundTests.AG_LV.graphics.attributes),
            GfxAttributesType.eTrajectory,
            TestBase.Application,
        )

        gfxAttrTimeComp: "VehicleGraphics2DAttributesTimeComponents" = clr.CastAs(
            EarlyBoundTests.AG_LV.graphics.attributes, VehicleGraphics2DAttributesTimeComponents
        )
    ...
    def test_GfxAttributesRealTime(self):
        ...
        if EarlyBoundTests.AG_LV.trajectory_type != PropagatorType.REAL_TIME:
            bCaught: bool = False
            try:
                bCaught = False
        ...
        EarlyBoundTests.AG_LV.set_trajectory_type(PropagatorType.REAL_TIME)
        ...
        oHelper.Run(
            VehicleGraphics2DAttributesRealtime(EarlyBoundTests.AG_LV.graphics.attributes),
            GfxAttributesType.eTrajectory,
        )
    ...
    def test_GfxGroundEllipses(self):
        ...
        sa.ephemeris_interval.set_start_and_stop_times(
            scene.start_time,
            TestBase.Application.conversion_utility.new_date("UTCG", str(scene.start_time))
            .add("sec", 120)
            .format("UTCG"),
        )
        sa.step = 13
    ...
    def test_VODropLines(self):
        ...
        oVO: "LaunchVehicleGraphics3D" = EarlyBoundTests.AG_LV.graphics_3d
    ...
    def test_ExportToDataFile(self):
        lv: "LaunchVehicle" = clr.CastAs(
            TestBase.Application.current_scenario.children.new(STKObjectType.LAUNCH_VEHICLE, "ExportLv"), LaunchVehicle
        )
        ...
        TestBase.Application.current_scenario.children.unload(STKObjectType.LAUNCH_VEHICLE, "ExportLv")
