...
class EarlyBoundTests(TestBase):
    ...
    def test_PLAT_40277_IAgVORefCrdnCollection_input_formats(self):
        ...
        refColl.add(GEOMETRIC_ELEMENT_TYPE.AXES_ELEMENT, "Satellite/Satellite2 Equinoctial Axes")  # full name
        refColl.add(GEOMETRIC_ELEMENT_TYPE.AXES_ELEMENT, "ICR Axes")  # short name

        refCrdn: "IGraphics3DReferenceAnalysisWorkbenchComponent" = refColl.get_component_by_name(
            GEOMETRIC_ELEMENT_TYPE.AXES_ELEMENT, "Satellite/Satellite2 Equinoctial Axes"
        )
        Assert.assertEqual("Satellite/Satellite2 Equinoctial Axes", refCrdn.name)

        refCrdn = refColl.get_component_by_name(GEOMETRIC_ELEMENT_TYPE.AXES_ELEMENT, "Equinoctial Axes")
        Assert.assertEqual("Satellite/Satellite2 Equinoctial Axes", refCrdn.name)

        refCrdn = refColl.get_component_by_name(GEOMETRIC_ELEMENT_TYPE.AXES_ELEMENT, "Satellite/Satellite2 ICR Axes")
        Assert.assertEqual("Satellite/Satellite2 ICR Axes", refCrdn.name)

        refCrdn = refColl.get_component_by_name(GEOMETRIC_ELEMENT_TYPE.AXES_ELEMENT, "ICR Axes")
        Assert.assertEqual("Satellite/Satellite2 ICR Axes", refCrdn.name)

        refColl.remove_by_name(GEOMETRIC_ELEMENT_TYPE.AXES_ELEMENT, "Satellite/Satellite2 Equinoctial Axes")
        refColl.remove_by_name(GEOMETRIC_ELEMENT_TYPE.AXES_ELEMENT, "Satellite/Satellite2 ICR Axes")

        # Vectors

        refColl.add(GEOMETRIC_ELEMENT_TYPE.VECTOR_ELEMENT, "Satellite/Satellite2 AngMomentum Vector")  # full name
        refColl.add(GEOMETRIC_ELEMENT_TYPE.VECTOR_ELEMENT, "AngVelocity Vector")  # short name

        refCrdn = refColl.get_component_by_name(
            GEOMETRIC_ELEMENT_TYPE.VECTOR_ELEMENT, "Satellite/Satellite2 AngMomentum Vector"
        )
        Assert.assertEqual("Satellite/Satellite2 AngMomentum Vector", refCrdn.name)

        refCrdn = refColl.get_component_by_name(GEOMETRIC_ELEMENT_TYPE.VECTOR_ELEMENT, "AngMomentum Vector")
        Assert.assertEqual("Satellite/Satellite2 AngMomentum Vector", refCrdn.name)

        refCrdn = refColl.get_component_by_name(
            GEOMETRIC_ELEMENT_TYPE.VECTOR_ELEMENT, "Satellite/Satellite2 AngVelocity Vector"
        )
        Assert.assertEqual("Satellite/Satellite2 AngVelocity Vector", refCrdn.name)

        refCrdn = refColl.get_component_by_name(GEOMETRIC_ELEMENT_TYPE.VECTOR_ELEMENT, "AngVelocity Vector")
        Assert.assertEqual("Satellite/Satellite2 AngVelocity Vector", refCrdn.name)

        refColl.remove_by_name(GEOMETRIC_ELEMENT_TYPE.VECTOR_ELEMENT, "Satellite/Satellite2 AngMomentum Vector")
        refColl.remove_by_name(GEOMETRIC_ELEMENT_TYPE.VECTOR_ELEMENT, "Satellite/Satellite2 AngVelocity Vector")
